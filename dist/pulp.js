...
<<<<<<< HEAD
>>>>>>> f4e4ce180f74ab5dae0089b2c6df04cae766c93e
=======
=======
>>>>>>> origin/payment-page-bb
>>>>>>> payment-pages-b
...
>>>>>>> payment-pages-b
  ...
  var scaleY = prop(PrestoDOM_Types_Core.numberIsProp)("scaleY");         
  ...
  exports["backgroundDrawable"] = backgroundDrawable;
...
(function(exports) {
  ...
  var PrestoDOM_Types_Core = PS["PrestoDOM.Types.Core"];
  var userInteraction = PrestoDOM_Properties.prop(PrestoDOM_Types_Core.stringIsProp)("userInteraction");
  var multipleLine = PrestoDOM_Properties.prop(PrestoDOM_Types_Core.stringIsProp)("multipleLine");
...
(function(exports) {
  ...
  var defConfig = {
      ...
      checkBoxVisibility: PrestoDOM_Types_DomAttributes.GONE.value,
      offerText: "",
      paymentOptionOffer: "",
      offerTextColor: "#aaaaaa",
      cardHeight: new PrestoDOM_Types_DomAttributes.V(64),
      rightArrowWidth: new PrestoDOM_Types_DomAttributes.V(24),
      rightArrowHeight: new PrestoDOM_Types_DomAttributes.V(24),
      id: 0,
      checkVisibility: PrestoDOM_Types_DomAttributes.GONE.value,
      clickable: true
  };
  exports["defConfig"] = defConfig;
})(PS["UI.Components.Config.PaymentOptions"] = PS["UI.Components.Config.PaymentOptions"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Prelude = PS["Prelude"];
  ...
  var defConfig = new Config({
      ...
      hourglassVisibility: PrestoDOM_Types_DomAttributes.GONE.value,
      secondaryTextVisible: PrestoDOM_Types_DomAttributes.GONE.value,
      inputVisibility: PrestoDOM_Types_DomAttributes.GONE.value,
...
})(PS["UI.Components.Controller.PaymentOptions"] = PS["UI.Components.Controller.PaymentOptions"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Data_Eq = PS["Data.Eq"];
  ...
  var view = function (push) {
      return function (v) {
          return PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(v.cardHeight), PrestoDOM_Properties.background("#ffffff"), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Events.onClick(push)(Data_Function["const"](new UI_Components_Controller_PaymentOptions.ToggleOption(v.id))), PrestoDOM_Properties.clickable(v.clickable) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.MarginLeft(16)) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.cornerRadius(12.0), PrestoDOM_Properties.stroke("1,#8b8b8b"), PrestoDOM_Properties.background("#ffffff"), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(0, 0, 12, 0)), PrestoDOM_Properties.visibility(v.checkBoxVisibility) ])([ PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(14)), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(14)), PrestoDOM_Properties.cornerRadius(7.0), PrestoDOM_Properties.visibility(v.checkVisibility), PrestoDOM_Properties.background("#b93540"), PrestoDOM_Properties.stroke("1,#8b8b8b") ]) ]), PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(32)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(32)), PrestoDOM_Properties.visibility((function () {
              var $3 = v.bankIconUrl === "";
              if ($3) {
                  return PrestoDOM_Types_DomAttributes.GONE.value;
              };
              return PrestoDOM_Types_DomAttributes.VISIBLE.value;
          })()), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.MarginRight(12)), PrestoDOM_Properties.imageUrl(v.bankIconUrl) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.weight(1.0) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.visibility((function () {
              var $4 = v.offerText === "";
              if ($4) {
                  return PrestoDOM_Types_DomAttributes.GONE.value;
              };
              return PrestoDOM_Types_DomAttributes.VISIBLE.value;
          })()) ])([  ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.gravity((function () {
              var $5 = v.offerText === "";
              if ($5) {
                  return PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value;
              };
              return PrestoDOM_Types_DomAttributes.BOTTOM.value;
          })()) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width((function () {
              var $6 = Engineering_Helpers_Commons.getOS(Data_Unit.unit) === "ANDROID";
              if ($6) {
                  return PrestoDOM_Types_DomAttributes.WRAP_CONTENT.value;
              };
              return PrestoDOM_Types_DomAttributes.MATCH_PARENT.value;
          })()), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.text(v.text), PrestoDOM_Properties.color(v.textColor), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.LEFT.value), PrestoDOM_Properties.textSize(18), PrestoDOM_Properties.typeface(v.typeface) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.visibility((function () {
              var $7 = v.paymentOptionOffer === "";
              if ($7) {
                  return PrestoDOM_Types_DomAttributes.GONE.value;
              };
              return PrestoDOM_Types_DomAttributes.VISIBLE.value;
          })()), PrestoDOM_Properties.text(v.paymentOptionOffer), PrestoDOM_Properties.background("#ca001a"), PrestoDOM_Properties.cornerRadius(9.0), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(8, 0, 8, 0)), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(8, 2, 0, 8)), PrestoDOM_Properties.color("#ffffff"), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.textSize(14), PrestoDOM_Properties.singleLine(false), Engineering_Helpers_Commons.multipleLine("true") ]) ]) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.visibility((function () {
              var $8 = v.offerText === "";
              if ($8) {
                  return PrestoDOM_Types_DomAttributes.GONE.value;
              };
              return PrestoDOM_Types_DomAttributes.VISIBLE.value;
          })()), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.LEFT.value), PrestoDOM_Properties.textSize(14), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(0, 0, 0, 0)), PrestoDOM_Properties.typeface(v.typeface), PrestoDOM_Properties.text(v.offerText), PrestoDOM_Properties.color(v.offerTextColor), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.singleLine(false), Engineering_Helpers_Commons.multipleLine("true") ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(28)), PrestoDOM_Properties.visibility((function () {
              var $9 = v.rightArrowUrl === "";
              if ($9) {
                  return PrestoDOM_Types_DomAttributes.GONE.value;
              };
              return PrestoDOM_Types_DomAttributes.VISIBLE.value;
          })()), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.MarginRight(10)) ])([ PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(v.rightArrowWidth), PrestoDOM_Properties.height(v.rightArrowHeight), PrestoDOM_Properties.imageUrl(v.rightArrowUrl) ]) ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(1)), PrestoDOM_Properties.visibility((function () {
              var $10 = v.lineSeparaterColor === "";
              if ($10) {
                  return PrestoDOM_Types_DomAttributes.GONE.value;
              };
              return PrestoDOM_Types_DomAttributes.VISIBLE.value;
          })()), PrestoDOM_Properties.background(v.lineSeparaterColor) ])([  ]) ]);
      };
  };
  exports["view"] = view;
})(PS["UI.Components.View.PaymentOptions"] = PS["UI.Components.View.PaymentOptions"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Data_Function = PS["Data.Function"];
  ...
  var view = function (push) {
      return function (v) {
          return PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(60)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(5, 5, 5, 5)), PrestoDOM_Properties.background(v.value0.background), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.translationZ(20.0) ])([ PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.LEFT.value), PrestoDOM_Properties.imageUrl(v.value0.imageUrl) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(32)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.padding(v.value0.padding), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.LEFT.value), PrestoDOM_Properties.color(v.value0.textcolor), PrestoDOM_Properties.textSize(22), PrestoDOM_Properties.text(v.value0.text), PrestoDOM_Properties.typeface(v.value0.typeface) ]), PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(28)), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(28)), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.LEFT.value), PrestoDOM_Properties.imageUrl("toolbar_hourglass_redbus"), PrestoDOM_Properties.visibility(v.value0.hourglassVisibility) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(32)), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(5, 0, 5, 0)), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.LEFT.value), PrestoDOM_Properties.color("#ffffff"), PrestoDOM_Properties.textSize(22), PrestoDOM_Properties.text(v.value0.secondaryText), PrestoDOM_Properties.visibility(v.value0.secondaryTextVisible) ]) ]);
      };
  };
  exports["view"] = view;
...
(function(exports) {
  ...
  var PrestoDOM = PS["PrestoDOM"];
  var PrestoDOM_Types_DomAttributes = PS["PrestoDOM.Types.DomAttributes"];
  var UI_Components_Config_Offers = PS["UI.Components.Config.Offers"];
  var UI_Components_Config_OrderSummary = PS["UI.Components.Config.OrderSummary"];
  var UI_Components_Config_PaymentCard = PS["UI.Components.Config.PaymentCard"];
  var UI_Components_Config_PaymentOptions = PS["UI.Components.Config.PaymentOptions"];
  var UI_Components_Config_ToolBar = PS["UI.Components.Config.ToolBar"];                 
  var toolBarConfigBigBasket = (function () {
      var toolBarConfig = {
          background: "#689F39",
          text: "Payment",
          padding: new PrestoDOM_Types_DomAttributes.Padding(10, 0, 0, 0),
          imageUrl: "toolbar_arrow_back_white",
          secondaryTextVisible: PrestoDOM_Types_DomAttributes.VISIBLE.value,
          secondaryText: "\u20b9 1800.30",
          hourglassVisibility: PrestoDOM_Types_DomAttributes.GONE.value,
  ...
  var bbWallet = (function () {
      var bbCon = {
          ...
          rightArrowWidth: new PrestoDOM_Types_DomAttributes.V(16),
          rightArrowHeight: new PrestoDOM_Types_DomAttributes.V(16),
          cardHeight: UI_Components_Config_PaymentOptions.defConfig.cardHeight,
          checkBoxVisibility: UI_Components_Config_PaymentOptions.defConfig.checkBoxVisibility,
          checkVisibility: UI_Components_Config_PaymentOptions.defConfig.checkVisibility,
          clickable: UI_Components_Config_PaymentOptions.defConfig.clickable,
          id: UI_Components_Config_PaymentOptions.defConfig.id,
          lineSeparaterColor: UI_Components_Config_PaymentOptions.defConfig.lineSeparaterColor,
          offerText: UI_Components_Config_PaymentOptions.defConfig.offerText,
          paymentOptionOffer: UI_Components_Config_PaymentOptions.defConfig.paymentOptionOffer,
          typeface: UI_Components_Config_PaymentOptions.defConfig.typeface
      };
      return bbCon;
  })();
  var bbUpi = (function () {
  ...
  var bbPayZapp = (function () {
      var bbCon = {
          ...
          rightArrowUrl: "bb_right_arrow",
          cardHeight: new PrestoDOM_Types_DomAttributes.V(88),
          rightArrowWidth: new PrestoDOM_Types_DomAttributes.V(16),
          rightArrowHeight: new PrestoDOM_Types_DomAttributes.V(16),
          checkBoxVisibility: UI_Components_Config_PaymentOptions.defConfig.checkBoxVisibility,
          checkVisibility: UI_Components_Config_PaymentOptions.defConfig.checkVisibility,
  ...
  var bbPayLater = (function () {
      var bbCon = {
          ...
          lineSeparaterColor: UI_Components_Config_PaymentOptions.defConfig.lineSeparaterColor,
          offerText: UI_Components_Config_PaymentOptions.defConfig.offerText,
          offerTextColor: UI_Components_Config_PaymentOptions.defConfig.offerTextColor,
          paymentOptionOffer: UI_Components_Config_PaymentOptions.defConfig.paymentOptionOffer,
          typeface: UI_Components_Config_PaymentOptions.defConfig.typeface
      };
      return bbCon;
  })();
  var bbNetBanking = (function () {
      var bbCon = {
          text: "Net Banking",
          textColor: "#4e4d4d",
  ...
  exports["toolBarConfigBigBasket"] = toolBarConfigBigBasket;
  exports["bbAirtelMoney"] = bbAirtelMoney;
  exports["bbPayZapp"] = bbPayZapp;
  exports["bbCreditCard"] = bbCreditCard;
  exports["bbWallet"] = bbWallet;
  exports["bbUpi"] = bbUpi;
  exports["bbNetBanking"] = bbNetBanking;
  exports["bbEasyEmi"] = bbEasyEmi;
  exports["bbPayLater"] = bbPayLater;
  exports["bbCod"] = bbCod;
})(PS["UI.Merchants.BigBasket.Config"] = PS["UI.Merchants.BigBasket.Config"] || {});
(function(exports) {
    "use strict";
...
})(PS["UI.Components.Controller.OrderSummary"] = PS["UI.Components.Controller.OrderSummary"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var PrestoDOM = PS["PrestoDOM"];
  var UI_Components_Config_Offers = PS["UI.Components.Config.Offers"];
  var UI_Components_Config_ToolBar = PS["UI.Components.Config.ToolBar"];
  var PreferredOptionID = (function () {
      function PreferredOptionID(value0) {
          this.value0 = value0;
      };
      PreferredOptionID.create = function (value0) {
          return new PreferredOptionID(value0);
      };
  ...
  var ShowSuccess = (function () {
      ...
      ShowSuccess.value = new ShowSuccess();
      return ShowSuccess;
  })();
  exports["ShowSuccess"] = ShowSuccess;
  exports["PreferredOptionID"] = PreferredOptionID;
  exports["None"] = None;
})(PS["UI.Types"] = PS["UI.Types"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var PrestoDOM_Events = PS["PrestoDOM.Events"];
  var PrestoDOM_Utils = PS["PrestoDOM.Utils"];
  var UI_Components_Config_NetBankCard = PS["UI.Components.Config.NetBankCard"];
  var UI_Components_Controller_NetBankCard = PS["UI.Components.Controller.NetBankCard"];
  var UI_Components_Controller_Offers = PS["UI.Components.Controller.Offers"];
  var UI_Components_Controller_OrderSummary = PS["UI.Components.Controller.OrderSummary"];
  var UI_Components_Controller_PaymentOptions = PS["UI.Components.Controller.PaymentOptions"];
  var UI_Components_Controller_ToolBar = PS["UI.Components.Controller.ToolBar"];
  var UI_Types = PS["UI.Types"];                 
  var BigBasketAction = (function () {
      function BigBasketAction() {

      };
      BigBasketAction.value = new BigBasketAction();
      return BigBasketAction;
  })();
  ...
  var PaymentOptionsAction = (function () {
      function PaymentOptionsAction(value0) {
          this.value0 = value0;
      };
      PaymentOptionsAction.create = function (value0) {
          return new PaymentOptionsAction(value0);
      };
      return PaymentOptionsAction;
  })();
  var PreferredOption = (function () {
      function PreferredOption(value0) {
          this.value0 = value0;
      };
      PreferredOption.create = function (value0) {
          return new PreferredOption(value0);
      };
...
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var JioCreditCard = (function () {
      function JioCreditCard() {

      };
      JioCreditCard.value = new JioCreditCard();
      return JioCreditCard;
  })();
  var JioDebitCard = (function () {
      function JioDebitCard() {

      };
      JioDebitCard.value = new JioDebitCard();
      return JioDebitCard;
  })();
  var JioUpi = (function () {
      function JioUpi() {
      ...
      JioUpi.value = new JioUpi();
      return JioUpi;
  })();
  exports["JioCreditCard"] = JioCreditCard;
  exports["JioDebitCard"] = JioDebitCard;
  exports["JioUpi"] = JioUpi;
})(PS["Types"] = PS["Types"] || {});
=======
=======
>>>>>>> payment-pages-b
  var Happened = (function () {
      ...
      Happened.value = new Happened();
      return Happened;
  })();
  var initialState = function (v) {
      return {
          orderSummaryState: UI_Components_Controller_OrderSummary.initialState,
          amount: v.amount,
          preferredOptions: v.preferredOptions,
          orderAmount: v.orderAmount,
          bbWalletAmount: v.bbWalletAmount,
          savedOptionDetails: v.savedOptionDetails
      };
  };
  var $$eval = function (v) {
      return function (state) {
          if (v instanceof Happened) {
              return PrestoDOM_Utils["continue"]((function () {
                  var $16 = {};
                  for (var $17 in state) {
          ...
          if (v instanceof BigBasketAction) {
              return PrestoDOM_Utils["continue"](state);
          };
          if (v instanceof PaymentOptionsAction) {
              return Control_Bind.bind(Data_Either.bindEither)(Control_Applicative.pure(Data_Either.applicativeEither)(Engineering_Helpers_Commons.log("getOS")))(function (v1) {
                  return Control_Bind.bind(Data_Either.bindEither)(Control_Applicative.pure(Data_Either.applicativeEither)(Effect_Console.logShow(Data_Show.showString)(Engineering_Helpers_Commons.getOS(Data_Unit.unit))))(function (v2) {
                      return PrestoDOM_Utils.exit(UI_Types.None.value);
                  });
              });
          };
          if (v instanceof PreferredOption) {
              if (v.value0 === 0) {
                  return PrestoDOM_Utils.exit(new UI_Types.PreferredOptionID(0));
              };
              if (v.value0 === 1) {
                  return PrestoDOM_Utils["continue"](state);
              };
  ...
  exports["BigBasketAction"] = BigBasketAction;
  exports["ToolBarAction"] = ToolBarAction;
  exports["PaymentOptionsAction"] = PaymentOptionsAction;
  exports["PreferredOption"] = PreferredOption;
  exports["Happened"] = Happened;
  exports["initialState"] = initialState;
  exports["eval"] = $$eval;
})(PS["UI.Merchants.BigBasket.Controller.BigBasketScreen"] = PS["UI.Merchants.BigBasket.Controller.BigBasketScreen"] || {});
(function(exports) {
    "use strict";
  /* global Symbol */
...
(function(exports) {
  ...
  var DebitCredit = (function () {
      ...
      DebitCredit.value = new DebitCredit();
      return DebitCredit;
  })();
...
(function(exports) {
  ...
  var PrestoDOM_Properties = PS["PrestoDOM.Properties"];
  var PrestoDOM_Types_DomAttributes = PS["PrestoDOM.Types.DomAttributes"];
  var UI_Merchants_BigBasket_Controller_BigBasketScreen = PS["UI.Merchants.BigBasket.Controller.BigBasketScreen"];
  var UI_Types = PS["UI.Types"];                 
  var view = function (push) {
      return function (v) {
          return function (index) {
              return PrestoDOM_Elements_Elements.linearLayout_("BigBasketSavedOptionScreen")([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(200)), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(300)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.background("#ffffff"), PrestoDOM_Properties.cornerRadius(4.0), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(16, 16, 16, 16)), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(0, 16, 0, 0)) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(108)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(16, 0, 0, 0)) ])([ PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(v.savedOptionIconWidth), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.imageUrl(v.savedOptionIcon), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.LEFT.value) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(0, 8, 0, 0)) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.weight(1.0) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(0, 0, 0, 8)) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width((function () {
                  var v1 = Engineering_Helpers_Commons.getOS(Data_Unit.unit);
                  if (v1 === "ANDROID") {
                      return PrestoDOM_Types_DomAttributes.WRAP_CONTENT.value;
                  };
                  return new PrestoDOM_Types_DomAttributes.V(Engineering_Helpers_Commons.getLabelWidth(v.savedOptionName)("AvenirNext-Medium")(18)(0)(0));
              })()), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.text(v.savedOptionName), PrestoDOM_Properties.textSize(18), PrestoDOM_Properties.color("#000000"), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.LEFT.value) ]), PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.imageUrl(v.savedOptionTypeIcon) ]) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.text(v.savedOptionDetails), PrestoDOM_Properties.textSize(20), PrestoDOM_Properties.color("#4C4B4C"), PrestoDOM_Properties.fontStyle("AvenirNext-Medium") ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value) ])([ PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(16)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(16)), PrestoDOM_Properties.imageUrl((function () {
                  var $6 = v.savedOptionOfferText === "";
                  if ($6) {
                      return "";
                  };
                  return "offers_icon";
              })()), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(0, 0, 8, 0)) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.text(v.savedOptionOfferText), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.textSize(14), PrestoDOM_Properties.color("#689F39"), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.LEFT.value), PrestoDOM_Properties.singleLine(false), Engineering_Helpers_Commons.multipleLine("true") ]) ]) ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(48)), PrestoDOM_Properties.background("#EF7674"), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.cornerRadius(4.0), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.PaddingBottom(4)), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.MarginTop(4)), PrestoDOM_Events.onClick(push)(Data_Function["const"](new UI_Merchants_BigBasket_Controller_BigBasketScreen.PreferredOption(index))), PrestoDOM_Properties.clickable(true) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.text("PAY NOW"), PrestoDOM_Properties.color("#ffffff"), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.textSize(20), PrestoDOM_Properties.fontStyle("AvenirNext-Medium") ]) ]) ]);
          };
      };
<<<<<<< HEAD
<<<<<<< HEAD
  ...
  var gravity = prop(PrestoDOM_Types_Core.gravityIsProp)("gravity");      
  var fontStyle = prop(PrestoDOM_Types_Core.stringIsProp)("fontStyle");  
  var focusable = prop(PrestoDOM_Types_Core.booleanIsProp)("focusable");
  var cornerRadius = prop(PrestoDOM_Types_Core.numberIsProp)("cornerRadius");
  var color = prop(PrestoDOM_Types_Core.stringIsProp)("color");               
  var clickable = prop(PrestoDOM_Types_Core.booleanIsProp)("clickable");           
  var background = prop(PrestoDOM_Types_Core.stringIsProp)("background");
...
>>>>>>> payment-pages-b
  ...
  exports["view"] = view;
})(PS["UI.Merchants.BigBasket.View.SavedOptions"] = PS["UI.Merchants.BigBasket.View.SavedOptions"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  ...
  var UI_Components_Config_PaymentOptions = PS["UI.Components.Config.PaymentOptions"];
  var UI_Components_Config_ToolBar = PS["UI.Components.Config.ToolBar"];
  var UI_Components_View_Offers = PS["UI.Components.View.Offers"];
  var UI_Components_View_PaymentOptions = PS["UI.Components.View.PaymentOptions"];
  var UI_Components_View_ToolBar = PS["UI.Components.View.ToolBar"];
  var UI_Merchants_BigBasket_Config = PS["UI.Merchants.BigBasket.Config"];
  var UI_Merchants_BigBasket_Controller_BigBasketScreen = PS["UI.Merchants.BigBasket.Controller.BigBasketScreen"];
  var UI_Merchants_BigBasket_View_SavedOptions = PS["UI.Merchants.BigBasket.View.SavedOptions"];
  var UI_Types = PS["UI.Types"];                 
  var orderSummary = function (push) {
      return function (state) {
          return PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.WRAP_CONTENT.value), PrestoDOM_Properties.background("#ffffff"), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(16, 16, 16, 16)) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(8, 0, 8, 8)) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.text("Total Basket Value"), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.textSize(16) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.WRAP_CONTENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.text("\u20b9 1,177"), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.textSize(16) ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(8, 0, 8, 8)) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.text("+ Delivery Charge"), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.textSize(16) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.WRAP_CONTENT.value), PrestoDOM_Properties.text("\u20b9 50"), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.textSize(16) ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(8, 0, 8, 8)) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.text("-  PhonePe Discount"), PrestoDOM_Properties.color("#689F39"), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.textSize(16) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.WRAP_CONTENT.value), PrestoDOM_Properties.text("\u20b9 78"), PrestoDOM_Properties.color("#689F39"), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.textSize(16) ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(8, 0, 8, 8)) ])([ PrestoDOM_Elements_Elements.relativeLayout([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(0, 0, 8, 0)) ])([ PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.imageUrl("bb_checkbox_bg") ]), PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(16)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(16)), PrestoDOM_Properties.imageUrl("bb_checkbox_checked"), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(2, 2, 0, 0)) ]) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.text("Settle BB wallet balance"), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.textSize(17) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.WRAP_CONTENT.value), PrestoDOM_Properties.text("\u20b9 7.00"), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.textSize(17) ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(28)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(8, 0, 8, 8)) ])([ PrestoDOM_Elements_Elements.relativeLayout([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(0, 0, 8, 0)) ])([ PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.imageUrl("bb_checkbox_bg"), PrestoDOM_Properties.visibility(PrestoDOM_Types_DomAttributes.INVISIBLE.value) ]), PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.cornerRadius(2.0), PrestoDOM_Properties.stroke("1,#aaaaaa") ]), PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(16)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(16)), PrestoDOM_Properties.imageUrl("bb_checkbox_checked"), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(2, 2, 0, 0)), PrestoDOM_Properties.visibility(PrestoDOM_Types_DomAttributes.INVISIBLE.value) ]) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.text("Join BBStar Membership"), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.textSize(17) ]), PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.WRAP_CONTENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(52)), PrestoDOM_Properties.imageUrl("bb_star") ]) ]), PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.WRAP_CONTENT.value), PrestoDOM_Properties.imageUrl("dashed_line"), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(8, 8, 8, 16)) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(28)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(8, 0, 8, 0)) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.text("Total Amount Payable"), PrestoDOM_Properties.typeface(PrestoDOM_Types_DomAttributes.BOLD.value), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.textSize(18), PrestoDOM_Properties.color("#000000") ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.WRAP_CONTENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.text("\u20b9 1,142"), PrestoDOM_Properties.typeface(PrestoDOM_Types_DomAttributes.BOLD.value), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.textSize(18), PrestoDOM_Properties.color("#000000") ]) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(16)), PrestoDOM_Properties.text("You saved \u20b9 246 on this order"), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(8, 0, 8, 8)), PrestoDOM_Properties.textSize(16), PrestoDOM_Properties.color("#689F39") ]) ]);
      };
  };
  var defaultSavedOption = {
      savedOptionIcon: "bb_paytm",
      savedOptionName: "Balance",
      savedOptionDetails: "\u20b9 800.00",
      savedOptionTypeIcon: "",
      savedOptionOfferText: "",
      savedOptionIconWidth: new PrestoDOM_Types_DomAttributes.V(48)
  };
  var savedOptions = function (push) {
      return function (state) {
          return [ UI_Merchants_BigBasket_View_SavedOptions.view(push)(Data_Maybe.fromMaybe(defaultSavedOption)(Data_Array.index(state.savedOptionDetails)(0)))(0), UI_Merchants_BigBasket_View_SavedOptions.view(push)(Data_Maybe.fromMaybe(defaultSavedOption)(Data_Array.index(state.savedOptionDetails)(1)))(1) ];
      };
  };
  var androidOffer = function (push) {
      return function (state) {
          return PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(60)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), (function () {
              var v = Engineering_Helpers_Commons.getOS(Data_Unit.unit);
              if (v === "ANDROID") {
                  return PrestoDOM_Properties.backgroundDrawable("big_basket_offers_background");
              };
              return PrestoDOM_Properties.stroke("1,#aaaaaa");
          })(), (function () {
              var v = Engineering_Helpers_Commons.getOS(Data_Unit.unit);
              if (v === "ANDROID") {
                  return PrestoDOM_Properties.backgroundDrawable("big_basket_offers_background");
              };
              return PrestoDOM_Properties.cornerRadius(4.0);
          })(), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(16, 8, 16, 8)), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(16, 16, 16, 8)), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value) ])([ PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(32)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(32)), PrestoDOM_Properties.imageUrl("offers_icon") ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.text("9 vouchers available"), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.textSize(18), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.LEFT.value), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(16, 0, 16, 0)), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(16, 0, 0, 0)) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(60)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.text("APPLY"), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.RIGHT.value), PrestoDOM_Properties.typeface(PrestoDOM_Types_DomAttributes.BOLD.value), PrestoDOM_Properties.color("#f90c00"), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(16, 0, 0, 0)), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(16, 0, 0, 0)) ]) ]);
      };
  };
  var body = function (push) {
      return function (state) {
          return [ orderSummary(push)(state), androidOffer(push)(state), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(16, 10, 10, 0)), PrestoDOM_Properties.text("PREFERRED OPTION"), PrestoDOM_Properties.typeface(PrestoDOM_Types_DomAttributes.BOLD.value), PrestoDOM_Properties.textSize(16) ]), PrestoDOM_Elements_Elements.horizontalScrollView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(230)) ])((function () {
              var v = Engineering_Helpers_Commons.getOS(Data_Unit.unit);
              if (v === "ANDROID") {
                  return [ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value) ])(savedOptions(push)(state)) ];
              };
              return savedOptions(push)(state);
          })()), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(16, 10, 10, 10)), PrestoDOM_Properties.text("OTHER OPTIONS"), PrestoDOM_Properties.typeface(PrestoDOM_Types_DomAttributes.BOLD.value), PrestoDOM_Properties.textSize(16) ]), UI_Components_View_PaymentOptions.view(function ($11) {
              return push(UI_Merchants_BigBasket_Controller_BigBasketScreen.PaymentOptionsAction.create($11));
          })(UI_Merchants_BigBasket_Config.bbAirtelMoney), UI_Components_View_PaymentOptions.view(function ($12) {
              return push(UI_Merchants_BigBasket_Controller_BigBasketScreen.PaymentOptionsAction.create($12));
          })(UI_Merchants_BigBasket_Config.bbPayZapp), UI_Components_View_PaymentOptions.view(function ($13) {
              return push(UI_Merchants_BigBasket_Controller_BigBasketScreen.PaymentOptionsAction.create($13));
          })(UI_Merchants_BigBasket_Config.bbCreditCard), UI_Components_View_PaymentOptions.view(function ($14) {
              return push(UI_Merchants_BigBasket_Controller_BigBasketScreen.PaymentOptionsAction.create($14));
          })(UI_Merchants_BigBasket_Config.bbWallet), UI_Components_View_PaymentOptions.view(function ($15) {
              return push(UI_Merchants_BigBasket_Controller_BigBasketScreen.PaymentOptionsAction.create($15));
          })(UI_Merchants_BigBasket_Config.bbUpi), UI_Components_View_PaymentOptions.view(function ($16) {
              return push(UI_Merchants_BigBasket_Controller_BigBasketScreen.PaymentOptionsAction.create($16));
          })(UI_Merchants_BigBasket_Config.bbNetBanking), UI_Components_View_PaymentOptions.view(function ($17) {
              return push(UI_Merchants_BigBasket_Controller_BigBasketScreen.PaymentOptionsAction.create($17));
          })(UI_Merchants_BigBasket_Config.bbEasyEmi), UI_Components_View_PaymentOptions.view(function ($18) {
              return push(UI_Merchants_BigBasket_Controller_BigBasketScreen.PaymentOptionsAction.create($18));
          })(UI_Merchants_BigBasket_Config.bbPayLater), UI_Components_View_PaymentOptions.view(function ($19) {
              return push(UI_Merchants_BigBasket_Controller_BigBasketScreen.PaymentOptionsAction.create($19));
          })(UI_Merchants_BigBasket_Config.bbCod) ];
      };
  };
  var view = function (push) {
      return function (state) {
          var toolbarConfig = {
              secondaryText: "\u20b9 " + state.amount,
              background: UI_Merchants_BigBasket_Config.toolBarConfigBigBasket.value0.background,
              hourglassVisibility: UI_Merchants_BigBasket_Config.toolBarConfigBigBasket.value0.hourglassVisibility,
              imageUrl: UI_Merchants_BigBasket_Config.toolBarConfigBigBasket.value0.imageUrl,
              inputUrl: UI_Merchants_BigBasket_Config.toolBarConfigBigBasket.value0.inputUrl,
              inputVisibility: UI_Merchants_BigBasket_Config.toolBarConfigBigBasket.value0.inputVisibility,
              padding: UI_Merchants_BigBasket_Config.toolBarConfigBigBasket.value0.padding,
              secondaryTextVisible: UI_Merchants_BigBasket_Config.toolBarConfigBigBasket.value0.secondaryTextVisible,
              text: UI_Merchants_BigBasket_Config.toolBarConfigBigBasket.value0.text,
              textSize: UI_Merchants_BigBasket_Config.toolBarConfigBigBasket.value0.textSize,
              textVisibility: UI_Merchants_BigBasket_Config.toolBarConfigBigBasket.value0.textVisibility,
              textcolor: UI_Merchants_BigBasket_Config.toolBarConfigBigBasket.value0.textcolor,
              textstyle: UI_Merchants_BigBasket_Config.toolBarConfigBigBasket.value0.textstyle,
              typeface: UI_Merchants_BigBasket_Config.toolBarConfigBigBasket.value0.typeface
          };
          return PrestoDOM_Elements_Elements.linearLayout_("BigBasketScreen")([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.background("#efefef"), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value) ])([ UI_Components_View_ToolBar.view(function ($20) {
              return push(UI_Merchants_BigBasket_Controller_BigBasketScreen.ToolBarAction.create($20));
          })(new UI_Components_Config_ToolBar.Config(toolbarConfig)), PrestoDOM_Elements_Elements.scrollView([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value) ])((function () {
              var v = Engineering_Helpers_Commons.getOS(Data_Unit.unit);
              if (v === "ANDROID") {
                  return [ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value) ])(body(push)(state)) ];
              };
              return body(push)(state);
          })()) ]);
      };
  };
  var screen = function (input) {
      return {
          initialState: UI_Merchants_BigBasket_Controller_BigBasketScreen.initialState(input),
          view: view,
          "eval": UI_Merchants_BigBasket_Controller_BigBasketScreen["eval"]
      };
  };
  exports["screen"] = screen;
  exports["view"] = view;
  exports["body"] = body;
  exports["defaultSavedOption"] = defaultSavedOption;
  exports["savedOptions"] = savedOptions;
  exports["androidOffer"] = androidOffer;
  exports["orderSummary"] = orderSummary;
})(PS["UI.Merchants.BigBasket.View.BigBasketScreen"] = PS["UI.Merchants.BigBasket.View.BigBasketScreen"] || {});
<<<<<<< HEAD
>>>>>>> f4e4ce180f74ab5dae0089b2c6df04cae766c93e
=======
=======
...
<<<<<<< HEAD
  ...
  var defConfig = new Config({
      ...
      color: "#aaaaaa",
      textSize: 14,
      textBoxHeight: PrestoDOM_Types_DomAttributes.MATCH_PARENT.value,
      ...
      headingWeight: 1.0,
      headingGravity: PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value,
      ...
      amountGravity: PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value,
...
>>>>>>> payment-pages-b
  ...
  var KeyAction = (function () {
      function KeyAction(value0) {
          this.value0 = value0;
      };
      KeyAction.create = function (value0) {
          return new KeyAction(value0);
      };
      return KeyAction;
  })();
  var Clear = (function () {
...
})(PS["UI.Components.Controller.KeyBoard"] = PS["UI.Components.Controller.KeyBoard"] || {});
(function(exports) {
...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];
  var PrestoDOM = PS["PrestoDOM"];
  var density = $foreign["_density"](Data_Unit.unit);
  var dpfy = Data_Semiring.mul(Data_Semiring.semiringNumber)(density);
...
(function(exports) {
  ...
  var PrestoDOM_Types_DomAttributes = PS["PrestoDOM.Types.DomAttributes"];
  var UI_Components_Controller_KeyBoard = PS["UI.Components.Controller.KeyBoard"];
  var UI_Constant_Accessibility_Default = PS["UI.Constant.Accessibility.Default"];
  var UI_Constant_Color_Default = PS["UI.Constant.Color.Default"];
  var UI_Constant_FontColor_Default = PS["UI.Constant.FontColor.Default"];
  var UI_Constant_FontSize_Default = PS["UI.Constant.FontSize.Default"];
  ...
  var key = function (push) {
      return function (backImg) {
          return function (enterImg) {
              return function (keyVal) {
                  var keyBody = function (keyVal1) {
                      if (keyVal1 === -1) {
                          return PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.imageUrl(backImg), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(24)) ]);
                      };
                      if (keyVal1 === 10) {
                          return PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.imageUrl(enterImg), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(48)), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(48)) ]);
                      };
                      return PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.text(Data_Show.show(Data_Show.showInt)(keyVal1)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.letterSpacing(2.0), PrestoDOM_Properties.textSize(32), PrestoDOM_Properties.color("#333333"), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(0, 10, 0, 20)) ]);
                  };
                  var forClear = Data_Array.singleton(PrestoDOM_Events.onClick(push)(Data_Function["const"](UI_Components_Controller_KeyBoard.Clear.value)));
                  return PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(40)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Events.onClick(push)((function () {
                      if (keyVal === -1) {
                          return Data_Function["const"](UI_Components_Controller_KeyBoard.Clear.value);
                      };
                      if (keyVal === 10) {
                          return Data_Function["const"](UI_Components_Controller_KeyBoard.Proceed.value);
                      };
                      return Data_Function["const"](new UI_Components_Controller_KeyBoard.KeyAction(keyVal));
                  })()), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value) ])([ keyBody(keyVal) ]);
              };
          };
>>>>>>> f4e4ce180f74ab5dae0089b2c6df04cae766c93e
      };
  };
  var keyboardRow = function (push) {
      return function (backImg) {
          return function (enterImg) {
              return function (elems) {
                  return PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(64)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value) ])(Data_Functor.map(Data_Functor.functorArray)(key(push)(backImg)(enterImg))(elems));
              };
          };
      };
<<<<<<< HEAD
...
=======
  ...
  var view = function (push) {
      return function (prop) {
          var keyboardHeight = UI_Utils.dpfy(256.0);
          var enterImg = Data_Maybe.fromMaybe(defaultProp.enterImg)(prop.enterImg);
          var backImg = Data_Maybe.fromMaybe(defaultProp.backImg)(prop.backImg);
          return PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(270)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.background("#F1F1F1"), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(20, 0, 20, 0)) ])(Data_Functor.map(Data_Functor.functorArray)(keyboardRow(push)(backImg)(enterImg))([ [ 1, 2, 3 ], [ 4, 5, 6 ], [ 7, 8, 9 ], [ -1 | 0, 0, 10 ] ]));
      };
  };
  exports["defaultProp"] = defaultProp;
  exports["view"] = view;
  exports["keyboardRow"] = keyboardRow;
  exports["key"] = key;
})(PS["UI.Components.View.KeyBoard"] = PS["UI.Components.View.KeyBoard"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var CVV_CHANGED = (function () {
      function CVV_CHANGED(value0) {
          this.value0 = value0;
      };
      CVV_CHANGED.create = function (value0) {
          return new CVV_CHANGED(value0);
      };
      return CVV_CHANGED;
  })();
  var KeyBoardAction = (function () {
      function KeyBoardAction(value0) {
          this.value0 = value0;
      };
      KeyBoardAction.create = function (value0) {
          return new KeyBoardAction(value0);
      };
      return KeyBoardAction;
  })();
  var CvvEntered = (function () {
      function CvvEntered() {

      };
      CvvEntered.value = new CvvEntered();
      return CvvEntered;
  })();
  var initialState = function (v) {
      return {
          ...
          offer: v.offer,
          bankIcon: v.bankIcon,
          keyBoardClearIcon: v.keyBoardClearIcon,
          keyBoardProceedIcon: v.keyBoardProceedIcon,
          cvv: ""
      };
  };
  var $$eval = function (v) {
      return function (state) {
          ...
          if (v instanceof CvvEntered) {
              return PrestoDOM_Utils.exit(UI_Types.ShowSuccess.value);
          };
          if (v instanceof CVV_CHANGED) {
              return PrestoDOM_Utils["continue"]((function () {
                  var $17 = {};
                  for (var $18 in state) {
          ...
          if (v instanceof PaymentOptionsAction) {
              return Control_Bind.bind(Data_Either.bindEither)(Control_Applicative.pure(Data_Either.applicativeEither)(Effect_Console.logShow(Data_Show.showInt)(v.value0.value0)))(function (v1) {
                  return Control_Bind.bind(Data_Either.bindEither)(Control_Applicative.pure(Data_Either.applicativeEither)(Engineering_Helpers_Commons.log("getOS")))(function (v2) {
                      return Control_Bind.bind(Data_Either.bindEither)(Control_Applicative.pure(Data_Either.applicativeEither)(Effect_Console.logShow(Data_Show.showString)(Engineering_Helpers_Commons.getOS(Data_Unit.unit))))(function (v3) {
                          return PrestoDOM_Utils["continue"](state);
                      });
                  });
              });
          };
          if (v instanceof KeyBoardAction && v.value0 instanceof UI_Components_Controller_KeyBoard.KeyAction) {
              return PrestoDOM_Utils["continue"]((function () {
                  var $23 = {};
                  for (var $24 in state) {
                  ...
                  $23.cvv = state.cvv + Data_Show.show(Data_Show.showInt)(v.value0.value0);
                  return $23;
              })());
          };
          if (v instanceof KeyBoardAction && v.value0 instanceof UI_Components_Controller_KeyBoard.Proceed) {
              return PrestoDOM_Utils["continue"]((function () {
                  var $28 = {};
                  for (var $29 in state) {
          ...
          if (v instanceof KeyBoardAction && v.value0 instanceof UI_Components_Controller_KeyBoard.Clear) {
              return Control_Bind.bind(Data_Either.bindEither)(Control_Applicative.pure(Data_Either.applicativeEither)(Engineering_Helpers_Commons.log(Engineering_Helpers_Commons.dropLastChar(state.cvv))))(function (v1) {
                  return PrestoDOM_Utils["continue"]((function () {
                      var $32 = {};
                      for (var $33 in state) {
                      ...
                      $32.cvv = Engineering_Helpers_Commons.dropLastChar(state.cvv);
                      return $32;
                  })());
              });
          };
  ...
  exports["ToolBarAction"] = ToolBarAction;
  exports["PaymentOptionsAction"] = PaymentOptionsAction;
  exports["CVV_CHANGED"] = CVV_CHANGED;
  exports["KeyBoardAction"] = KeyBoardAction;
  exports["CvvEntered"] = CvvEntered;
  exports["initialState"] = initialState;
  exports["eval"] = $$eval;
})(PS["UI.Merchants.BigBasket.Controller.CvvScreen"] = PS["UI.Merchants.BigBasket.Controller.CvvScreen"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
...
(function(exports) {
  ...
  var jioCardCvvEditText = (function () {
      var editTextConfig = {
          parentHeight: new PrestoDOM_Types_DomAttributes.V(40),
          hint: "",
          rowStroke: "1,#bdbdbd",
          rowCornerRadius: 4.0,
          rowPadding: new PrestoDOM_Types_DomAttributes.Padding(4, 0, 4, 0),
          imageUrl: "card_type_visa",
          pipeVisibility: PrestoDOM_Types_DomAttributes.GONE.value,
          background: defEditTextConfig.value0.background,
          editTextBackground: defEditTextConfig.value0.editTextBackground,
          editTextSize: defEditTextConfig.value0.editTextSize,
          font: defEditTextConfig.value0.font,
          imageBackground: defEditTextConfig.value0.imageBackground,
          imageHeight: defEditTextConfig.value0.imageHeight,
          imageMargin: defEditTextConfig.value0.imageMargin,
          imagePadding: defEditTextConfig.value0.imagePadding,
          imageVisibility: defEditTextConfig.value0.imageVisibility,
          imageWidth: defEditTextConfig.value0.imageWidth,
          inputType: defEditTextConfig.value0.inputType,
          parentBackground: defEditTextConfig.value0.parentBackground,
          parentMargin: defEditTextConfig.value0.parentMargin,
          parentPadding: defEditTextConfig.value0.parentPadding,
          parentWidth: defEditTextConfig.value0.parentWidth,
          rowHeight: defEditTextConfig.value0.rowHeight,
          rowWidth: defEditTextConfig.value0.rowWidth
      };
      return new EditTextConfig(editTextConfig);
  })();
  var jioCardMonthEditText = (function () {
      var editTextConfig = {
          parentHeight: new PrestoDOM_Types_DomAttributes.V(40),
          hint: "Month",
          rowStroke: "1,#bdbdbd",
  ...
  var jioCardNameEditText = (function () {
      var editTextConfig = {
          parentHeight: new PrestoDOM_Types_DomAttributes.V(40),
          ...
          imageMargin: defEditTextConfig.value0.imageMargin,
          imagePadding: defEditTextConfig.value0.imagePadding,
          imageUrl: defEditTextConfig.value0.imageUrl,
          imageVisibility: defEditTextConfig.value0.imageVisibility,
          imageWidth: defEditTextConfig.value0.imageWidth,
          parentBackground: defEditTextConfig.value0.parentBackground,
          parentMargin: defEditTextConfig.value0.parentMargin,
          parentPadding: defEditTextConfig.value0.parentPadding,
          parentWidth: defEditTextConfig.value0.parentWidth,
          pipeVisibility: defEditTextConfig.value0.pipeVisibility,
          rowHeight: defEditTextConfig.value0.rowHeight,
          rowWidth: defEditTextConfig.value0.rowWidth
      };
      return new EditTextConfig(editTextConfig);
  })();
  var jioCardNumberEditText = (function () {
      var editTextConfig = {
          parentHeight: new PrestoDOM_Types_DomAttributes.V(40),
          hint: "Enter card number",
          rowStroke: "1,#bdbdbd",
          ...
          rowPadding: new PrestoDOM_Types_DomAttributes.Padding(4, 0, 4, 0),
          imageUrl: "ic_card",
          pipeVisibility: PrestoDOM_Types_DomAttributes.VISIBLE.value,
  ...
  var jioCardYearEditText = (function () {
      var editTextConfig = {
          parentHeight: new PrestoDOM_Types_DomAttributes.V(40),
          hint: "Year",
          rowStroke: "1,#bdbdbd",
  ...
  exports["Config"] = Config;
<<<<<<< HEAD
  exports["jioCardNumberEditText"] = jioCardNumberEditText;
  exports["jioCardNameEditText"] = jioCardNameEditText;
  exports["jioCardMonthEditText"] = jioCardMonthEditText;
  exports["jioCardYearEditText"] = jioCardYearEditText;
  exports["jioCardCvvEditText"] = jioCardCvvEditText;
})(PS["UI.Components.Config.AddCardV2"] = PS["UI.Components.Config.AddCardV2"] || {});
=======
  };
  var defaultProp = {
      backImg: "ic_keyboard_back",
...
(function(exports) {
  ...
  var initialState = {};
  exports["initialState"] = initialState;
})(PS["UI.Components.Controller.AddCard"] = PS["UI.Components.Controller.AddCard"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Data_Eq = PS["Data.Eq"];
...
<<<<<<< HEAD
  ...
  var Types = PS["Types"];
  var UI_Components_Config_AddCardV2 = PS["UI.Components.Config.AddCardV2"];
  var UI_Components_Controller_AddCardV2 = PS["UI.Components.Controller.AddCardV2"];                 
  var _addCardEditTextV1 = function (v) {
      return PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(v.value0.parentHeight), PrestoDOM_Properties.width(v.value0.parentWidth), PrestoDOM_Properties.margin(v.value0.parentMargin), PrestoDOM_Properties.padding(v.value0.parentPadding), PrestoDOM_Properties.background(v.value0.parentBackground), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(v.value0.rowHeight), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.background("#f5f5f5"), PrestoDOM_Properties.stroke(v.value0.rowStroke), PrestoDOM_Properties.cornerRadius(v.value0.rowCornerRadius), PrestoDOM_Properties.padding(v.value0.rowPadding) ])([ PrestoDOM_Elements_Elements.editText([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(10, 0, 0, 0)), PrestoDOM_Properties.inputType(v.value0.inputType), PrestoDOM_Properties.background(v.value0.editTextBackground), PrestoDOM_Properties.hint(v.value0.hint), PrestoDOM_Properties.textSize(v.value0.editTextSize) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(1)), PrestoDOM_Properties.background("#bdbdbd"), PrestoDOM_Properties.visibility(v.value0.pipeVisibility) ])([  ]), PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(v.value0.imageWidth), PrestoDOM_Properties.visibility(v.value0.imageVisibility), PrestoDOM_Properties.imageUrl(v.value0.imageUrl), PrestoDOM_Properties.background(v.value0.imageBackground), PrestoDOM_Properties.padding(v.value0.imagePadding) ]) ]) ]);
  };
  var view = function (push) {
      return function (v) {
          return PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(v.value0.height), PrestoDOM_Properties.background(v.value0.background), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.margin(v.value0.margin), PrestoDOM_Properties.padding(v.value0.padding), PrestoDOM_Properties.stroke("1,#aaaaaa"), PrestoDOM_Properties.cornerRadius(v.value0.cornerRadius) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(50)) ])([ PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.imageUrl("add_new_card_jio_visa") ]), PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.imageUrl("add_new_card_jio_mastercard") ]), PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.imageUrl("add_new_card_jio_americanexp") ]), PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.imageUrl("add_new_card_jio_dinersclub") ]), PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.imageUrl("add_new_card_jio_rupay") ]) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.text("Card Number"), PrestoDOM_Properties.textSize(16), PrestoDOM_Properties.typeface(PrestoDOM_Types_DomAttributes.BOLD.value), PrestoDOM_Properties.color("#000000"), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(10, 10, 10, 10)), PrestoDOM_Properties.fontStyle(v.value0.font) ]), _addCardEditTextV1(v.value0.editTextCardConfig), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(30)), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(0, 0, 0, 0)) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.text("Expiration Date"), PrestoDOM_Properties.textSize(16), PrestoDOM_Properties.typeface(PrestoDOM_Types_DomAttributes.BOLD.value), PrestoDOM_Properties.color("#000000"), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(10, 0, 10, 10)), PrestoDOM_Properties.fontStyle(v.value0.font) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(100)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.text("CVV/CVC"), PrestoDOM_Properties.textSize(16), PrestoDOM_Properties.typeface(PrestoDOM_Types_DomAttributes.BOLD.value), PrestoDOM_Properties.color("#000000"), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(10, 0, 10, 10)), PrestoDOM_Properties.fontStyle(v.value0.font) ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(40)) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(120)) ])([ _addCardEditTextV1(v.value0.editTextMonthConfig) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(100)) ])([ _addCardEditTextV1(v.value0.editTextYearConfig) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0) ])([ _addCardEditTextV1(v.value0.editTextCvvConfig) ]) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.text("Card Holder Name"), PrestoDOM_Properties.textSize(16), PrestoDOM_Properties.typeface(PrestoDOM_Types_DomAttributes.BOLD.value), PrestoDOM_Properties.color("#000000"), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(10, 10, 10, 10)), PrestoDOM_Properties.fontStyle(v.value0.font) ]), _addCardEditTextV1(v.value0.editTextNameConfig) ]);
=======
=======
>>>>>>> payment-pages-b
  var UI_Components_Config_PaymentOptions = PS["UI.Components.Config.PaymentOptions"];
  var UI_Components_Config_ToolBar = PS["UI.Components.Config.ToolBar"];
  var UI_Components_View_KeyBoard = PS["UI.Components.View.KeyBoard"];
  var UI_Components_View_Offers = PS["UI.Components.View.Offers"];
  var UI_Components_View_PaymentOptions = PS["UI.Components.View.PaymentOptions"];
  var UI_Components_View_ToolBar = PS["UI.Components.View.ToolBar"];
  var UI_Merchants_BigBasket_Config = PS["UI.Merchants.BigBasket.Config"];
  var UI_Merchants_BigBasket_Controller_CvvScreen = PS["UI.Merchants.BigBasket.Controller.CvvScreen"];
  var UI_Merchants_BigBasket_View_SavedOptions = PS["UI.Merchants.BigBasket.View.SavedOptions"];                 
  var cvvView = function (push) {
      return function (state) {
          return PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(130)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(72)), PrestoDOM_Properties.background("#FFFFFF"), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.MarginTop(16)), PrestoDOM_Properties.visibility(PrestoDOM_Types_DomAttributes.VISIBLE.value) ])([ PrestoDOM_Elements_Elements.relativeLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value) ])([ PrestoDOM_Elements_Elements.editText([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Events.onChange(push)(UI_Merchants_BigBasket_Controller_CvvScreen.CVV_CHANGED.create), PrestoDOM_Properties.inputType(PrestoDOM_Types_DomAttributes.NumericPassword.value) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.background("#ffffff"), Engineering_Helpers_Commons.userInteraction("false") ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.text((function () {
              var $4 = Data_String_CodePoints.length(state.cvv) === 0;
              if ($4) {
                  return "C";
              };
              return Data_String_CodeUnits.singleton(Data_Maybe.fromMaybe(" ")(Data_String_CodeUnits.charAt(0)(state.cvv)));
          })()), PrestoDOM_Properties.textSize(45), PrestoDOM_Properties.scaleY(1.5), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.color("#000000"), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.alpha((function () {
              var v = Data_String_CodeUnits.charAt(0)(state.cvv);
              if (v instanceof Data_Maybe.Nothing) {
                  return 0.3;
              };
              return 1.0;
          })()) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.text((function () {
              var $6 = Data_String_CodePoints.length(state.cvv) === 0;
              if ($6) {
                  return "V";
              };
              return Data_String_CodeUnits.singleton(Data_Maybe.fromMaybe(" ")(Data_String_CodeUnits.charAt(1)(state.cvv)));
          })()), PrestoDOM_Properties.textSize(45), PrestoDOM_Properties.color("#000000"), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.scaleY(1.5), PrestoDOM_Properties.alpha((function () {
              var v = Data_String_CodeUnits.charAt(0)(state.cvv);
              if (v instanceof Data_Maybe.Nothing) {
                  return 0.3;
              };
              ...
              var $8 = Data_String_CodePoints.length(state.cvv) === 0;
              if ($8) {
                  return "V";
              };
              return Data_String_CodeUnits.singleton(Data_Maybe.fromMaybe(" ")(Data_String_CodeUnits.charAt(2)(state.cvv)));
          })()), PrestoDOM_Properties.color("#000000"), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.textSize(45), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.scaleY(1.5), PrestoDOM_Properties.alpha((function () {
              var v = Data_String_CodeUnits.charAt(0)(state.cvv);
              if (v instanceof Data_Maybe.Nothing) {
                  return 0.3;
              };
              return 1.0;
          })()) ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(4)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), Engineering_Helpers_Commons.userInteraction("false") ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.background("#EF7674"), PrestoDOM_Properties.visibility((function () {
              var $10 = Data_String_CodePoints.length(state.cvv) === 0;
              if ($10) {
                  return PrestoDOM_Types_DomAttributes.VISIBLE.value;
              };
              return PrestoDOM_Types_DomAttributes.INVISIBLE.value;
          })()), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value) ])([  ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.background("#EF7674"), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.visibility((function () {
              var $11 = Data_String_CodePoints.length(state.cvv) === 1;
              if ($11) {
                  return PrestoDOM_Types_DomAttributes.VISIBLE.value;
              };
              return PrestoDOM_Types_DomAttributes.INVISIBLE.value;
          })()) ])([  ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.background("#EF7674"), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.visibility((function () {
              var $12 = Data_String_CodePoints.length(state.cvv) >= 2;
              if ($12) {
                  return PrestoDOM_Types_DomAttributes.VISIBLE.value;
              };
              return PrestoDOM_Types_DomAttributes.INVISIBLE.value;
  ...
  var view = function (push) {
      return function (state) {
          ...
          return PrestoDOM_Elements_Elements.linearLayout_("BigBasketCvvScreen")([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.background("#f1f1f1"), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_HORIZONTAL.value) ])([ UI_Components_View_ToolBar.view(function ($16) {
              return push(UI_Merchants_BigBasket_Controller_CvvScreen.ToolBarAction.create($16));
          })(new UI_Components_Config_ToolBar.Config(toolbarConfig)), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.background("#ffffff"), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(16, 16, 16, 16)), PrestoDOM_Properties.cornerRadius(8.0) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(300)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.background("#ffffff"), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(0, 16, 0, 0)) ])([ PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(32)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(32)), PrestoDOM_Properties.imageUrl("bank_kotak"), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(8, 0, 8, 0)) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.LEFT.value), PrestoDOM_Properties.text("Kotak Credit Card"), PrestoDOM_Properties.textSize(16), PrestoDOM_Properties.fontStyle("AvenirNext-Medium") ]), PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(16)), PrestoDOM_Properties.imageUrl("bb_visa_logo") ]) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.text("5000 **** **** 1234"), PrestoDOM_Properties.typeface(PrestoDOM_Types_DomAttributes.BOLD.value), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.textSize(16), PrestoDOM_Properties.color("#000000") ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(32)), PrestoDOM_Properties.text("RS. 100 cashback above Rs. 500 "), PrestoDOM_Properties.color("#00FF00"), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.textSize(16), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.LEFT.value) ]), cvvView(push)(state) ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(48)), PrestoDOM_Properties.cornerRadius(8.0), PrestoDOM_Properties.background("#EF7674"), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.PaddingBottom(8)), PrestoDOM_Properties.visibility((function () {
              var $14 = Data_String_CodePoints.length(state.cvv) > 2;
              if ($14) {
                  return PrestoDOM_Types_DomAttributes.VISIBLE.value;
              };
              return PrestoDOM_Types_DomAttributes.GONE.value;
          })()), PrestoDOM_Events.onClick(push)(Data_Function["const"](UI_Merchants_BigBasket_Controller_CvvScreen.CvvEntered.value)) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.text("PAY NOW"), PrestoDOM_Properties.color("#ffffff"), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.textSize(20), PrestoDOM_Properties.background("#EF7674") ]) ]) ]), UI_Components_View_KeyBoard.view(function ($17) {
              return push(UI_Merchants_BigBasket_Controller_CvvScreen.KeyBoardAction.create($17));
          })({
              enterImg: new Data_Maybe.Just("ic_keyboard_enter"),
              backImg: new Data_Maybe.Just("ic_keyboard_back")
          }) ]);
      };
  };
  var screen = function (input) {
      return {
          initialState: UI_Merchants_BigBasket_Controller_CvvScreen.initialState(input),
          view: view,
          "eval": function (action) {
              return function (state) {
                  return UI_Merchants_BigBasket_Controller_CvvScreen["eval"](Debug_Trace.spy(Debug_Trace.warn())("ACTION")(action))(Debug_Trace.spy(Debug_Trace.warn())("STATE")(state));
              };
          }
=======
  var Types = PS["Types"];
...
})(PS["UI.Components.View.AddCardV2"] = PS["UI.Components.View.AddCardV2"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var initialState = {};
...
=======
>>>>>>> payment-pages-b
  exports["cvvView"] = cvvView;
})(PS["UI.Merchants.BigBasket.View.CvvScreen"] = PS["UI.Merchants.BigBasket.View.CvvScreen"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Data_Function = PS["Data.Function"];
  ...
  var initialState = function (v) {
      return {
          ...
          paymentStatusIcon: v.paymentStatusIcon
      };
  };
  var $$eval = function (v) {
      return function (state) {
  ...
  exports["initialState"] = initialState;
  exports["eval"] = $$eval;
})(PS["UI.Merchants.BigBasket.Controller.PaymentSuccessful"] = PS["UI.Merchants.BigBasket.Controller.PaymentSuccessful"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
...
<<<<<<< HEAD
  ...
  var view = function (push) {
      return function (v) {
          return function (state) {
              return PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(v.value0.heightParent), PrestoDOM_Properties.width(v.value0.widthParent), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value), PrestoDOM_Properties.background(v.value0.background), PrestoDOM_Properties.padding(v.value0.padding), PrestoDOM_Properties.margin(v.value0.margin), PrestoDOM_Properties.cornerRadius(v.value0.cornerRadius) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.orientation(v.value0.orientation), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(v.value0.headingHeight), PrestoDOM_Properties.weight(v.value0.headingWeight), PrestoDOM_Properties.width(v.value0.headingWidth), PrestoDOM_Properties.color(v.value0.headingColor), PrestoDOM_Properties.text(v.value0.headingText), PrestoDOM_Properties.gravity(v.value0.headingGravity), PrestoDOM_Properties.textSize(v.value0.headingTextSize), PrestoDOM_Properties.typeface(v.value0.headingTypeface), PrestoDOM_Properties.fontStyle(v.value0.font) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(1)), PrestoDOM_Properties.visibility(v.value0.pipeVisibility), PrestoDOM_Properties.background("#ffffff"), PrestoDOM_Properties.fontStyle(v.value0.font) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(v.value0.textBoxHeight), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.width(v.value0.width), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(v.value0.height), PrestoDOM_Properties.color(v.value0.color), PrestoDOM_Properties.text(v.value0.text), PrestoDOM_Properties.gravity(v.value0.gravity), PrestoDOM_Properties.textSize(v.value0.textSize), PrestoDOM_Properties.typeface(v.value0.typeface), PrestoDOM_Properties.fontStyle(v.value0.font) ]) ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.WRAP_CONTENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.text(v.value0.amountHeadingText), PrestoDOM_Properties.textSize(16), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value), PrestoDOM_Properties.color("#80ffffff"), PrestoDOM_Properties.visibility(v.value0.amountHeadingVisibility), PrestoDOM_Properties.fontStyle(v.value0.font) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(v.value0.amountHeight), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.color(v.value0.amountColor), PrestoDOM_Properties.text(v.value0.amountText), PrestoDOM_Properties.textSize(v.value0.amountTextSize), PrestoDOM_Properties.visibility(v.value0.amountVisibility), PrestoDOM_Properties.gravity(v.value0.amountGravity), PrestoDOM_Properties.typeface(v.value0.amountTypeface), PrestoDOM_Properties.fontStyle(v.value0.font) ]) ]) ]), PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.height(v.value0.imageHeight), PrestoDOM_Properties.width(v.value0.imageWidth), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.visibility(v.value0.imageVisibility), PrestoDOM_Properties.imageUrl(v.value0.imageUrl), PrestoDOM_Properties.margin(v.value0.imageMargin) ]) ]);
          };
      };
  };
  exports["view"] = view;
...
<<<<<<< HEAD
  ...
  var view = function (push) {
      return function (v) {
          return PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(v.value0.height), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(1, 1, 1, 1)), PrestoDOM_Properties.margin(v.value0.margin), PrestoDOM_Properties.background(v.value0.background), PrestoDOM_Properties.cornerRadius(v.value0.cornerRadius), PrestoDOM_Properties.stroke(v.value0.stroke) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.text(v.value0.text), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.color(v.value0.color), PrestoDOM_Properties.textSize(v.value0.textSize), PrestoDOM_Properties.typeface(v.value0.typeface), PrestoDOM_Properties.fontStyle(v.value0.font) ]) ]);
      };
  };
  exports["view"] = view;
...
>>>>>>> payment-pages-b
  ...
  var UI_Components_View_ToolBar = PS["UI.Components.View.ToolBar"];
  var UI_Merchants_BigBasket_Config = PS["UI.Merchants.BigBasket.Config"];
  var UI_Merchants_BigBasket_Controller_PaymentSuccessful = PS["UI.Merchants.BigBasket.Controller.PaymentSuccessful"];                 
  var view = function (push) {
      return function (state) {
          var toolbarConfig = {
              secondaryText: "\u20b9 " + state.amount,
          ...
          var v = Engineering_Helpers_Commons.log("INSIDE PAYMENT SUCCESSFUL");
          return PrestoDOM_Elements_Elements.linearLayout_("BigBasketScreenPaymentSuccessfulScreen")([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.background("#efefef"), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value) ])([ UI_Components_View_ToolBar.view(function ($6) {
              return push(UI_Merchants_BigBasket_Controller_PaymentSuccessful.ToolBarAction.create($6));
          })(new UI_Components_Config_ToolBar.Config(toolbarConfig)), PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(240)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(240)), PrestoDOM_Properties.imageUrl(state.paymentStatusIcon), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(0, 52, 0, 48)) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(40)), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.text(state.paymentStatus), PrestoDOM_Properties.color("#333333"), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.typeface(PrestoDOM_Types_DomAttributes.BOLD.value), PrestoDOM_Properties.textSize(25) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0) ])([  ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(0, 0, 0, 42)) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width((function () {
              var v1 = Engineering_Helpers_Commons.getOS(Data_Unit.unit);
              if (v1 === "ANDROID") {
                  return PrestoDOM_Types_DomAttributes.WRAP_CONTENT.value;
              };
              return new PrestoDOM_Types_DomAttributes.V(Engineering_Helpers_Commons.getLabelWidth("You can view your order ")("AvenirNext-Medium")(18)(0)(0));
          })()), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.text("You can view your order "), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.textSize(18) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(50)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.text("here"), PrestoDOM_Properties.textSize(18), PrestoDOM_Properties.fontStyle("AvenirNext-Medium"), PrestoDOM_Properties.color("#689F39") ]) ]) ]);
      };
  };
  var screen = function (input) {
      return {
          initialState: UI_Merchants_BigBasket_Controller_PaymentSuccessful.initialState(input),
          view: view,
          "eval": UI_Merchants_BigBasket_Controller_PaymentSuccessful["eval"]
      };
  };
  exports["screen"] = screen;
  exports["view"] = view;
})(PS["UI.Merchants.BigBasket.View.PaymentSuccessful"] = PS["UI.Merchants.BigBasket.View.PaymentSuccessful"] || {});
<<<<<<< HEAD
>>>>>>> f4e4ce180f74ab5dae0089b2c6df04cae766c93e
=======
=======
...
<<<<<<< HEAD
  ...
  var UI_Merchants_BigBasket_View_BigBasketScreen = PS["UI.Merchants.BigBasket.View.BigBasketScreen"];
  var UI_Merchants_BigBasket_View_CvvScreen = PS["UI.Merchants.BigBasket.View.CvvScreen"];
  var UI_Merchants_BigBasket_View_OtpScreen = PS["UI.Merchants.BigBasket.View.OtpScreen"];
  var UI_Merchants_BigBasket_View_PaymentSuccessful = PS["UI.Merchants.BigBasket.View.PaymentSuccessful"];
  var UI_Merchants_Dream11_View_AddCardScreen = PS["UI.Merchants.Dream11.View.AddCardScreen"];
  var UI_Merchants_Dream11_View_Dream11Screen = PS["UI.Merchants.Dream11.View.Dream11Screen"];
  var UI_Merchants_Dream11_View_NetBankingScreen = PS["UI.Merchants.Dream11.View.NetBankingScreen"];
  var UI_Merchants_Dream11_View_WalletsScreen = PS["UI.Merchants.Dream11.View.WalletsScreen"];
  var UI_Merchants_Goibibo_View_GoibiboScreen = PS["UI.Merchants.Goibibo.View.GoibiboScreen"];
  var UI_Merchants_Grofers_View_GrofersScreen = PS["UI.Merchants.Grofers.View.GrofersScreen"];
  var UI_Merchants_Jio_View_JioScreen = PS["UI.Merchants.Jio.View.JioScreen"];
  var UI_Merchants_Ola_View_OlaScreen = PS["UI.Merchants.Ola.View.OlaScreen"];
  var UI_Merchants_RedBus_View_RedBusScreen = PS["UI.Merchants.RedBus.View.RedBusScreen"];
  var UI_Merchants_SpiceJet_View_SpiceJetScreen = PS["UI.Merchants.SpiceJet.View.SpiceJetScreen"];
  var UI_Merchants_Vodafone_View_VodafoneScreen = PS["UI.Merchants.Vodafone.View.VodafoneScreen"];
  var UI_Types = PS["UI.Types"];
  ...
  var bigBasketPaymentSuccessful = Control_Bind.bind(Control_Monad_Free.freeBind)(Debug_Trace.spy(Debug_Trace.warn())("ASDF")(Presto_Core_Types_Language_Flow.runScreen(UI_Merchants_BigBasket_View_PaymentSuccessful.screen({
      amount: "1300.0",
  ...
  var bigBasketCvv = Control_Bind.bind(Control_Monad_Free.freeBind)(Presto_Core_Types_Language_Flow.runScreen(UI_Merchants_BigBasket_View_CvvScreen.screen({
      amount: "1400",
      bankName: "Kotak Credit Card",
      cardNumber: "5000 **** **** 1234",
      offer: "Applied offer - Rs 100 Cashback will be credited your card in 7 days",
      bankIcon: "bank_kotak",
      keyBoardClearIcon: "ic_keyboard_enter",
      keyBoardProceedIcon: "ic_keyboard_back"
  })))(function (v) {
      return Control_Bind.bind(Control_Monad_Free.freeBind)((function () {
          if (v instanceof UI_Types.ShowSuccess) {
              return Debug_Trace.spy(Debug_Trace.warn())("ASDF")(bigBasketPaymentSuccessful);
          };
          return Debug_Trace.spy(Debug_Trace.warn())("ASDF FAILURE")(Control_Applicative.pure(Control_Monad_Free.freeApplicative))(Data_Unit.unit);
      })())(function (v1) {
          return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(Data_Unit.unit);
      });
  });
  var bigBasketApp = Control_Bind.bind(Control_Monad_Free.freeBind)(Presto_Core_Types_Language_Flow.runScreen(UI_Merchants_BigBasket_View_BigBasketScreen.screen({
      amount: "1300.0",
      preferredOptions: [  ],
      orderAmount: "60",
      bbWalletAmount: "6.90",
      savedOptionDetails: [ {
          savedOptionIcon: "bank_kotak",
          savedOptionName: "Kotak Credit",
          savedOptionDetails: "5001 **** **** 1234",
          savedOptionTypeIcon: "bb_visa_logo",
          savedOptionOfferText: "Get 10% discount on orders above Rs. 99.  No need for coupon code.",
          savedOptionIconWidth: new PrestoDOM_Types_DomAttributes.V(24)
      }, {
          savedOptionIcon: "bb_paytm",
          savedOptionName: "Balance",
          savedOptionDetails: "\u20b9 800.00",
      ...
      return Control_Bind.bind(Control_Monad_Free.freeBind)((function () {
          if (v instanceof UI_Types.PreferredOptionID && v.value0 === 0) {
              return bigBasketCvv;
          };
          return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(Data_Unit.unit);
      })())(function (v1) {
  ...
  var appFlow = function (recreated) {
      return Control_Bind.bind(Control_Monad_Free.freeBind)(Presto_Core_Types_Language_Flow.initUI)(function (v) {
          return Control_Bind.bind(Control_Monad_Free.freeBind)(bigBasketApp)(function (v1) {
              return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(Data_Unit.unit);
          });
      });
  };
  exports["bigBasketApp"] = bigBasketApp;
  exports["bigBasketCvv"] = bigBasketCvv;
  exports["bigBasketPaymentSuccessful"] = bigBasketPaymentSuccessful;
...
(function(exports) {
  ...
  var view = function (push) {
      return function (v) {
          return PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(60)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.padding(v.value0.parentPadding), PrestoDOM_Properties.background(v.value0.background), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.translationY(v.value0.translationY), PrestoDOM_Properties.translationZ(v.value0.translationZ) ])([ PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(40)), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.LEFT.value), PrestoDOM_Properties.imageUrl(v.value0.imageUrl) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(32)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.padding(v.value0.padding), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value), PrestoDOM_Properties.color(v.value0.textColor), PrestoDOM_Properties.textSize(v.value0.textSize), PrestoDOM_Properties.text(v.value0.text), PrestoDOM_Properties.typeface(v.value0.typeface), PrestoDOM_Properties.visibility((function () {
              if (v.value0.inputVisibility) {
                  return PrestoDOM_Types_DomAttributes.GONE.value;
              };
              return PrestoDOM_Types_DomAttributes.VISIBLE.value;
          })()), PrestoDOM_Properties.fontStyle(v.value0.font) ]), PrestoDOM_Elements_Elements.editText([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(32)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.padding(v.value0.padding), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value), PrestoDOM_Properties.typeface(v.value0.textStyle), PrestoDOM_Properties.color(v.value0.textColor), PrestoDOM_Properties.background(v.value0.background), PrestoDOM_Properties.textSize(v.value0.textSize), PrestoDOM_Properties.hint(v.value0.hintText), PrestoDOM_Properties.hintColor(v.value0.hintColor), PrestoDOM_Properties.visibility((function () {
              if (v.value0.inputVisibility) {
                  return PrestoDOM_Types_DomAttributes.VISIBLE.value;
              };
              return PrestoDOM_Types_DomAttributes.GONE.value;
          })()) ]), PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.height(v.value0.actionIconSize), PrestoDOM_Properties.width(v.value0.actionIconSize), PrestoDOM_Properties.imageUrl(v.value0.actionIcon), PrestoDOM_Properties.visibility(v.value0.iconVisibility), PrestoDOM_Events.onClick(push)(Data_Function["const"](UI_Components_Controller_ToolBar.ActionIconClicked.value)) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(32)), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(5, 0, 5, 0)), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value), PrestoDOM_Properties.color("#ffffff"), PrestoDOM_Properties.textSize(22), PrestoDOM_Properties.text(v.value0.secondaryText), PrestoDOM_Properties.visibility(v.value0.secondaryTextVisible), PrestoDOM_Properties.fontStyle(v.value0.font) ]) ]);
      };
  };
  exports["view"] = view;
})(PS["UI.Components.View.ToolBar"] = PS["UI.Components.View.ToolBar"] || {});
...
(function(exports) {
  ...
  exports["defConfig"] = defConfig;
  exports["Config"] = Config;
})(PS["UI.Components.Config.EditText"] = PS["UI.Components.Config.EditText"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Prelude = PS["Prelude"];
  ...
  var defConfig = new Config({
      ...
      margin: new PrestoDOM_Types_DomAttributes.Margin(0, 0, 0, 0),
      iconUrl: "",
      iconWidth: new PrestoDOM_Types_DomAttributes.V(40),
      iconHeight: new PrestoDOM_Types_DomAttributes.V(40),
      cardWidth: PrestoDOM_Types_DomAttributes.MATCH_PARENT.value,
      cardHeight: new PrestoDOM_Types_DomAttributes.V(50),
      lineSeparatorColor: "#aaaaaa",
      lineSeparatorHeight: 1,
      ...
      lineSeparatorMargin: new PrestoDOM_Types_DomAttributes.Margin(0, 0, 0, 0),
      background: "#FFFFFF",
      gravity: PrestoDOM_Types_DomAttributes.START.value,
      textSize: 18,
      text: "",
      font: "Roboto-Regular"
  });
  exports["defConfig"] = defConfig;
  exports["Config"] = Config;
})(PS["UI.Components.Config.EditTextV2"] = PS["UI.Components.Config.EditTextV2"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Prelude = PS["Prelude"];
  ...
  var defConfig = {
      ...
      checkVisibility: PrestoDOM_Types_DomAttributes.GONE.value,
      isFormVisible: true,
      iconSize: new PrestoDOM_Types_DomAttributes.V(32),
      font: "Roboto-Regular"
  };
  exports["defConfig"] = defConfig;
})(PS["UI.Components.Config.PaymentOptions"] = PS["UI.Components.Config.PaymentOptions"] || {});
...
(function(exports) {
  ...
  var UI_Components_Config_EditText = PS["UI.Components.Config.EditText"];
  var UI_Components_Config_EditTextV2 = PS["UI.Components.Config.EditTextV2"];
  var UI_Components_Config_PaymentOptions = PS["UI.Components.Config.PaymentOptions"];
  ...
  var UI_Components_Config_ToolBar = PS["UI.Components.Config.ToolBar"];                 
  var screenFont = "Roboto-Regular";
  var toolBarConfigJio = (function () {
      var toolBarConfig = {
          background: "#214796",
          text: "Recharge",
          padding: new PrestoDOM_Types_DomAttributes.Padding(40, 0, 0, 0),
  ...
  var jioWalletEditText = (function () {
      var editTextConfig = {
          lineSeparatorHeight: 1,
          lineSeparatorColor: "#aaaaaa",
          lineSeparatorMargin: new PrestoDOM_Types_DomAttributes.Margin(32, 0, 32, 0),
          hintOutOfEditText: false,
          hint: "8889250288",
          textColor: "#797877",
          tickVisibility: PrestoDOM_Types_DomAttributes.GONE.value,
          iconUrl: "",
          editTextPadding: new PrestoDOM_Types_DomAttributes.Padding(8, 0, 8, 0),
          gravity: PrestoDOM_Types_DomAttributes.CENTER.value,
          textSize: 22,
          font: screenFont,
          background: UI_Components_Config_EditTextV2.defConfig.value0.background,
          cardHeight: UI_Components_Config_EditTextV2.defConfig.value0.cardHeight,
          cardWidth: UI_Components_Config_EditTextV2.defConfig.value0.cardWidth,
          editTextVisibility: UI_Components_Config_EditTextV2.defConfig.value0.editTextVisibility,
          hintColor: UI_Components_Config_EditTextV2.defConfig.value0.hintColor,
          iconHeight: UI_Components_Config_EditTextV2.defConfig.value0.iconHeight,
          iconWidth: UI_Components_Config_EditTextV2.defConfig.value0.iconWidth,
          inputType: UI_Components_Config_EditTextV2.defConfig.value0.inputType,
          margin: UI_Components_Config_EditTextV2.defConfig.value0.margin,
          text: UI_Components_Config_EditTextV2.defConfig.value0.text,
          visibility: UI_Components_Config_EditTextV2.defConfig.value0.visibility
      };
      return new UI_Components_Config_EditTextV2.Config(editTextConfig);
  })();
  var jioVpaEditText = (function () {
      var editTextConfig = {
          rowHeight: new PrestoDOM_Types_DomAttributes.V(50),
          parentHeight: new PrestoDOM_Types_DomAttributes.V(50),
          hint: "eg. abc@psp",
          ...
          parentMargin: new PrestoDOM_Types_DomAttributes.Margin(0, 0, 0, 0),
          font: screenFont,
          background: UI_Components_Config_EditText.defConfig.value0.background,
          editTextBackground: UI_Components_Config_EditText.defConfig.value0.editTextBackground,
          editTextSize: UI_Components_Config_EditText.defConfig.value0.editTextSize,
          imageBackground: UI_Components_Config_EditText.defConfig.value0.imageBackground,
          imageHeight: UI_Components_Config_EditText.defConfig.value0.imageHeight,
          imageMargin: UI_Components_Config_EditText.defConfig.value0.imageMargin,
          imagePadding: UI_Components_Config_EditText.defConfig.value0.imagePadding,
          imageUrl: UI_Components_Config_EditText.defConfig.value0.imageUrl,
          imageWidth: UI_Components_Config_EditText.defConfig.value0.imageWidth,
          isFormVisible: UI_Components_Config_EditText.defConfig.value0.isFormVisible,
          parentBackground: UI_Components_Config_EditText.defConfig.value0.parentBackground,
          parentPadding: UI_Components_Config_EditText.defConfig.value0.parentPadding,
          parentWidth: UI_Components_Config_EditText.defConfig.value0.parentWidth,
          pipeVisibility: UI_Components_Config_EditText.defConfig.value0.pipeVisibility,
          rowWidth: UI_Components_Config_EditText.defConfig.value0.rowWidth,
          text: UI_Components_Config_EditText.defConfig.value0.text,
          textColor: UI_Components_Config_EditText.defConfig.value0.textColor,
          textHeight: UI_Components_Config_EditText.defConfig.value0.textHeight,
          textMargin: UI_Components_Config_EditText.defConfig.value0.textMargin,
          textSize: UI_Components_Config_EditText.defConfig.value0.textSize,
          typeface: UI_Components_Config_EditText.defConfig.value0.typeface
      };
      return new UI_Components_Config_EditText.Config(editTextConfig);
  })();
  var jioUpiConfig = (function () {
      var cardConfig = {
          amount: "Pay",
          imageUrl: "ic_upi",
          headingText: "UPI",
          headingHeight: new PrestoDOM_Types_DomAttributes.V(30),
          height: new PrestoDOM_Types_DomAttributes.V(50),
          parentPadding: new PrestoDOM_Types_DomAttributes.Padding(0, 0, 0, 0),
          imageWidth: new PrestoDOM_Types_DomAttributes.V(50),
          amountGravity: PrestoDOM_Types_DomAttributes.CENTER.value,
          amountColor: "#253185",
          ...
          text: UI_Components_Config_PaymentOptionsV2.defConfig.value0.text
      };
      return new UI_Components_Config_PaymentOptionsV2.Config(cardConfig);
  })();
  var jioSubmitButton = (function () {
      var primarySubmitConfig = {
          text: "Submit",
          background: "#253185",
          color: "#ffffff",
          margin: new PrestoDOM_Types_DomAttributes.Margin(32, 20, 32, 0),
          cornerRadius: 0.0,
          height: new PrestoDOM_Types_DomAttributes.V(45),
          font: screenFont,
      ...
      return new UI_Components_Config_PrimaryButton.Config(primarySubmitConfig);
  })();
  var jioPhonepeConfig = (function () {
      var cardConfig = {
          amount: "Pay",
  ...
  var jioPaytmConfig = (function () {
      var cardConfig = {
          ...
          amountStroke: "1,#253185",
          amountCornerRadius: 20.0,
          lineSeparaterVisibility: PrestoDOM_Types_DomAttributes.VISIBLE.value,
          id: 3,
          font: screenFont,
          amountBackground: UI_Components_Config_PaymentOptionsV2.defConfig.value0.amountBackground,
          amountWidth: UI_Components_Config_PaymentOptionsV2.defConfig.value0.amountWidth,
  ...
  var jioPayButton = (function () {
      var parimaryPayConfig = {
          text: "Make Payment",
          background: "#F0C351",
          color: "#000000",
          margin: new PrestoDOM_Types_DomAttributes.Margin(0, 20, 0, 0),
          cornerRadius: 5.0,
          font: screenFont,
          height: UI_Components_Config_PrimaryButton.defConfig.value0.height,
          stroke: UI_Components_Config_PrimaryButton.defConfig.value0.stroke,
          textSize: UI_Components_Config_PrimaryButton.defConfig.value0.textSize,
          typeface: UI_Components_Config_PrimaryButton.defConfig.value0.typeface
      };
      return new UI_Components_Config_PrimaryButton.Config(parimaryPayConfig);
  })();
  var jioNet = (function () {
      var jioConfig = {
          text: "Net Banking",
          checkBoxVisibility: PrestoDOM_Types_DomAttributes.VISIBLE.value,
          lineSeparaterColor: "",
          id: 3,
          font: screenFont,
          background: UI_Components_Config_PaymentOptions.defConfig.background,
          bankIconUrl: UI_Components_Config_PaymentOptions.defConfig.bankIconUrl,
          cardHeight: UI_Components_Config_PaymentOptions.defConfig.cardHeight,
          checkVisibility: UI_Components_Config_PaymentOptions.defConfig.checkVisibility,
          iconSize: UI_Components_Config_PaymentOptions.defConfig.iconSize,
          isFormVisible: UI_Components_Config_PaymentOptions.defConfig.isFormVisible,
          offerText: UI_Components_Config_PaymentOptions.defConfig.offerText,
          offerTextColor: UI_Components_Config_PaymentOptions.defConfig.offerTextColor,
          paymentOptionOffer: UI_Components_Config_PaymentOptions.defConfig.paymentOptionOffer,
          rightArrowHeight: UI_Components_Config_PaymentOptions.defConfig.rightArrowHeight,
          rightArrowUrl: UI_Components_Config_PaymentOptions.defConfig.rightArrowUrl,
          rightArrowWidth: UI_Components_Config_PaymentOptions.defConfig.rightArrowWidth,
          textColor: UI_Components_Config_PaymentOptions.defConfig.textColor,
          typeface: UI_Components_Config_PaymentOptions.defConfig.typeface
      };
      return jioConfig;
  })();
  var jioMoneyConfig = (function () {
      var cardConfig = {
          amount: "Pay",
  ...
  var amountV2ConfigJio = (function () {
      var amountConfig = {
          text: "\u20b9",
          width: new PrestoDOM_Types_DomAttributes.V(50),
          textSize: 18,
          amountTextSize: 22,
          color: "#000000",
          headingColor: "#0d479e",
          margin: new PrestoDOM_Types_DomAttributes.Margin(20, 10, 20, 8),
          padding: new PrestoDOM_Types_DomAttributes.Padding(40, 0, 40, 0),
          cornerRadius: 8.0,
          background: "#bbdefb",
          amountColor: "#0d479e",
          headingText: "Payment Amount: ",
          amountText: "19.00",
          amountTypeface: PrestoDOM_Types_DomAttributes.BOLD.value,
          font: screenFont,
          ...
          amountVisibility: UI_Components_Config_AmountView.defConfig.value0.amountVisibility,
          gravity: UI_Components_Config_AmountView.defConfig.value0.gravity,
          headingGravity: UI_Components_Config_AmountView.defConfig.value0.headingGravity,
          headingHeight: UI_Components_Config_AmountView.defConfig.value0.headingHeight,
          headingTextSize: UI_Components_Config_AmountView.defConfig.value0.headingTextSize,
          headingTypeface: UI_Components_Config_AmountView.defConfig.value0.headingTypeface,
          headingWeight: UI_Components_Config_AmountView.defConfig.value0.headingWeight,
          headingWidth: UI_Components_Config_AmountView.defConfig.value0.headingWidth,
          height: UI_Components_Config_AmountView.defConfig.value0.height,
          ...
          textBoxHeight: UI_Components_Config_AmountView.defConfig.value0.textBoxHeight,
          typeface: UI_Components_Config_AmountView.defConfig.value0.typeface,
  ...
  var amountConfigJio = (function () {
      var amountConfig = {
          ...
          height: new PrestoDOM_Types_DomAttributes.V(20),
          pipeVisibility: PrestoDOM_Types_DomAttributes.VISIBLE.value,
          padding: new PrestoDOM_Types_DomAttributes.Padding(10, 5, 10, 5),
          font: screenFont,
          ...
          textBoxHeight: UI_Components_Config_AmountView.defConfig.value0.textBoxHeight,
          typeface: UI_Components_Config_AmountView.defConfig.value0.typeface,
          width: UI_Components_Config_AmountView.defConfig.value0.width,
          widthParent: UI_Components_Config_AmountView.defConfig.value0.widthParent
      };
      return new UI_Components_Config_AmountView.Config(amountConfig);
  })();
  var addCardConfigJio = (function () {
      var addCardConfig = {
          height: PrestoDOM_Types_DomAttributes.MATCH_PARENT.value,
          padding: new PrestoDOM_Types_DomAttributes.Padding(0, 0, 0, 10),
          margin: new PrestoDOM_Types_DomAttributes.Margin(0, 0, 0, 0),
          cornerRadius: 5.0,
          font: screenFont,
          background: UI_Components_Config_AddCardV2.defConfig.value0.background,
          editTextCardConfig: UI_Components_Config_AddCardV2.defConfig.value0.editTextCardConfig,
          editTextCvvConfig: UI_Components_Config_AddCardV2.defConfig.value0.editTextCvvConfig,
          editTextMonthConfig: UI_Components_Config_AddCardV2.defConfig.value0.editTextMonthConfig,
          editTextNameConfig: UI_Components_Config_AddCardV2.defConfig.value0.editTextNameConfig,
          editTextYearConfig: UI_Components_Config_AddCardV2.defConfig.value0.editTextYearConfig
      };
      return new UI_Components_Config_AddCardV2.Config(addCardConfig);
  })();
  exports["screenFont"] = screenFont;
  exports["toolBarConfigJio"] = toolBarConfigJio;
  exports["amountConfigJio"] = amountConfigJio;
  exports["amountV2ConfigJio"] = amountV2ConfigJio;
  exports["addCardConfigJio"] = addCardConfigJio;
  exports["jioPhonepeConfig"] = jioPhonepeConfig;
  exports["jioPaytmConfig"] = jioPaytmConfig;
  exports["jioUpiConfig"] = jioUpiConfig;
  exports["jioMoneyConfig"] = jioMoneyConfig;
  exports["jioCredit"] = jioCredit;
  exports["jioDebit"] = jioDebit;
  exports["jioNet"] = jioNet;
  exports["jioPayButton"] = jioPayButton;
  exports["jioBankListItem"] = jioBankListItem;
  exports["jioWalletEditText"] = jioWalletEditText;
  exports["jioSubmitButton"] = jioSubmitButton;
  exports["jioVpaEditText"] = jioVpaEditText;
})(PS["UI.Merchants.Jio.Config"] = PS["UI.Merchants.Jio.Config"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Data_Function = PS["Data.Function"];
...
(function(exports) {
  ...
  var UI_Components_Controller_PrimaryButton = PS["UI.Components.Controller.PrimaryButton"];
  var UI_Components_Controller_ToolBar = PS["UI.Components.Controller.ToolBar"];                 
  var CreditCardAction = (function () {
      function CreditCardAction() {

      };
      CreditCardAction.value = new CreditCardAction();
  ...
  var PayButtonAction = (function () {
      function PayButtonAction(value0) {
          this.value0 = value0;
      };
      PayButtonAction.create = function (value0) {
          return new PayButtonAction(value0);
      };
      return PayButtonAction;
  })();
  ...
  var $$eval = function (v) {
      return function (state) {
          if (v instanceof CreditCardAction) {
              return PrestoDOM_Utils["continue"](state);
          };
          return PrestoDOM_Utils["continue"](state);
      };
  };
  exports["CreditCardAction"] = CreditCardAction;
  exports["ToolBarAction"] = ToolBarAction;
  exports["AmountViewAction"] = AmountViewAction;
  exports["AddCardAction"] = AddCardAction;
  exports["PayButtonAction"] = PayButtonAction;
  exports["initialState"] = initialState;
  exports["eval"] = $$eval;
})(PS["UI.Merchants.Jio.Controller.CreditCardScreen"] = PS["UI.Merchants.Jio.Controller.CreditCardScreen"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  ...
  var UI_Components_Config_AmountView = PS["UI.Components.Config.AmountView"];
  var UI_Components_Config_ToolBar = PS["UI.Components.Config.ToolBar"];
  var UI_Components_View_AddCardV2 = PS["UI.Components.View.AddCardV2"];
  ...
  var UI_Components_View_ToolBar = PS["UI.Components.View.ToolBar"];
  var UI_Merchants_Jio_Config = PS["UI.Merchants.Jio.Config"];
  var UI_Merchants_Jio_Controller_CreditCardScreen = PS["UI.Merchants.Jio.Controller.CreditCardScreen"];                 
  var view = function (push) {
      return function (state) {
          return PrestoDOM_Elements_Elements.linearLayout_("CreditCardScreen")([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.background("#ffffff"), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value) ])([ UI_Components_View_ToolBar.view(function ($0) {
              return push(UI_Merchants_Jio_Controller_CreditCardScreen.ToolBarAction.create($0));
          })(UI_Merchants_Jio_Config.toolBarConfigJio), PrestoDOM_Elements_Elements.scrollView([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value) ])([ UI_Components_View_AmountView.view(function ($1) {
              return push(UI_Merchants_Jio_Controller_CreditCardScreen.AmountViewAction.create($1));
          })(UI_Merchants_Jio_Config.amountV2ConfigJio)(state.orderSummaryState), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(20, 20, 20, 0)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(30)), PrestoDOM_Properties.text("Pay by Credit Card"), PrestoDOM_Properties.color("#2A3890") ]), UI_Components_View_AddCardV2.view(function ($2) {
              return push(UI_Merchants_Jio_Controller_CreditCardScreen.AddCardAction.create($2));
          })(UI_Merchants_Jio_Config.addCardConfigJio), UI_Components_View_PrimaryButton.view(function ($3) {
              return push(UI_Merchants_Jio_Controller_CreditCardScreen.PayButtonAction.create($3));
          })(UI_Merchants_Jio_Config.jioPayButton), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(50)), PrestoDOM_Properties.text("Cancel"), PrestoDOM_Properties.color("#2A3890"), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.textSize(18) ]) ]) ]) ]) ]);
      };
  };
  var screen = function (input) {
      return {
          initialState: UI_Merchants_Jio_Controller_CreditCardScreen.initialState(input),
          view: view,
          "eval": UI_Merchants_Jio_Controller_CreditCardScreen["eval"]
      };
  };
  exports["screen"] = screen;
  exports["view"] = view;
})(PS["UI.Merchants.Jio.View.CreditCardScreen"] = PS["UI.Merchants.Jio.View.CreditCardScreen"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Effect = PS["Effect"];
  ...
  var UI_Components_Controller_PrimaryButton = PS["UI.Components.Controller.PrimaryButton"];
  var UI_Components_Controller_ToolBar = PS["UI.Components.Controller.ToolBar"];                 
  var DebitCardAction = (function () {
      function DebitCardAction() {

      };
      DebitCardAction.value = new DebitCardAction();
      return DebitCardAction;
  })();
  var ToolBarAction = (function () {
      function ToolBarAction(value0) {
          this.value0 = value0;
  ...
  var $$eval = function (v) {
      return function (state) {
          if (v instanceof DebitCardAction) {
              return PrestoDOM_Utils["continue"](state);
          };
          return PrestoDOM_Utils["continue"](state);
      };
  };
  exports["DebitCardAction"] = DebitCardAction;
  exports["ToolBarAction"] = ToolBarAction;
  exports["AmountViewAction"] = AmountViewAction;
  exports["AddCardAction"] = AddCardAction;
  exports["PayButtonAction"] = PayButtonAction;
  exports["initialState"] = initialState;
  exports["eval"] = $$eval;
})(PS["UI.Merchants.Jio.Controller.DebitCardScreen"] = PS["UI.Merchants.Jio.Controller.DebitCardScreen"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  ...
  var UI_Components_View_ToolBar = PS["UI.Components.View.ToolBar"];
  var UI_Merchants_Jio_Config = PS["UI.Merchants.Jio.Config"];
  var UI_Merchants_Jio_Controller_DebitCardScreen = PS["UI.Merchants.Jio.Controller.DebitCardScreen"];                 
  var view = function (push) {
      return function (state) {
          return PrestoDOM_Elements_Elements.linearLayout_("DebitCardScreen")([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.background("#ffffff"), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value) ])([ UI_Components_View_ToolBar.view(function ($0) {
              return push(UI_Merchants_Jio_Controller_DebitCardScreen.ToolBarAction.create($0));
          })(UI_Merchants_Jio_Config.toolBarConfigJio), PrestoDOM_Elements_Elements.scrollView([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value) ])([ UI_Components_View_AmountView.view(function ($1) {
              return push(UI_Merchants_Jio_Controller_DebitCardScreen.AmountViewAction.create($1));
          })(UI_Merchants_Jio_Config.amountV2ConfigJio)(state.orderSummaryState), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(20, 20, 20, 0)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(30)), PrestoDOM_Properties.text("Pay by Debit Card"), PrestoDOM_Properties.color("#2A3890") ]), UI_Components_View_AddCardV2.view(function ($2) {
              return push(UI_Merchants_Jio_Controller_DebitCardScreen.AddCardAction.create($2));
          })(UI_Merchants_Jio_Config.addCardConfigJio), UI_Components_View_PrimaryButton.view(function ($3) {
              return push(UI_Merchants_Jio_Controller_DebitCardScreen.PayButtonAction.create($3));
          })(UI_Merchants_Jio_Config.jioPayButton), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(50)), PrestoDOM_Properties.text("Cancel"), PrestoDOM_Properties.color("#2A3890"), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.textSize(18) ]) ]) ]) ]) ]);
      };
  };
  var screen = function (input) {
      return {
          initialState: UI_Merchants_Jio_Controller_DebitCardScreen.initialState(input),
          view: view,
          "eval": UI_Merchants_Jio_Controller_DebitCardScreen["eval"]
      };
  };
  exports["screen"] = screen;
  exports["view"] = view;
})(PS["UI.Merchants.Jio.View.DebitCardScreen"] = PS["UI.Merchants.Jio.View.DebitCardScreen"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Data_Function = PS["Data.Function"];
  ...
  var radioButton = function (push) {
      return function (config) {
          return function (state) {
              return [ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(config.radioSize), PrestoDOM_Properties.width(config.radioSize), PrestoDOM_Properties.cornerRadius(100.0), PrestoDOM_Properties.stroke("1," + config.radioOuterColor), PrestoDOM_Properties.background("#ffffff"), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.padding(config.radioPadding) ])([ PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.cornerRadius(100.0), PrestoDOM_Properties.background((function () {
                  if (state.active) {
  ...
  var body = function (push) {
      return function (v) {
          return function (state) {
              return Data_Semigroup.append(Data_Semigroup.semigroupArray)((function () {
              ...
              })()), PrestoDOM_Properties.visibility(v.value0.bankImageVisible), PrestoDOM_Properties.imageUrl(state.logo) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.color(v.value0.bankTextColor), PrestoDOM_Properties.margin((function () {
                  if (v.value0.orientation instanceof PrestoDOM_Types_DomAttributes.HORIZONTAL) {
                      return new PrestoDOM_Types_DomAttributes.MarginLeft(10);
                  };
                  if (v.value0.orientation instanceof PrestoDOM_Types_DomAttributes.VERTICAL) {
                  ...
                  throw new Error("Failed pattern match at UI.Components.View.BankListItem (line 57, column 26 - line 59, column 54): " + [ v.value0.orientation.constructor.name ]);
              })()), PrestoDOM_Properties.textSize(v.value0.bankTextSize), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value), PrestoDOM_Properties.text(state.name), PrestoDOM_Properties.fontStyle(v.value0.font) ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)((function () {
...
(function(exports) {
  ...
  var Types = PS["Types"];
  var UI_Components_Config_EditTextV2 = PS["UI.Components.Config.EditTextV2"];
  var UI_Components_Controller_EditTextV2 = PS["UI.Components.Controller.EditTextV2"];                 
  var view = function (push) {
      return function (v) {
          return PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(v.value0.cardWidth), PrestoDOM_Properties.height(v.value0.cardHeight), PrestoDOM_Properties.background(v.value0.background), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.margin(v.value0.margin), PrestoDOM_Properties.visibility(v.value0.visibility) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.text(v.value0.hint), PrestoDOM_Properties.color("#aaaaaa"), PrestoDOM_Properties.visibility((function () {
              if (v.value0.hintOutOfEditText) {
              ...
              return v.value0.hint;
          })()), PrestoDOM_Properties.color(v.value0.textColor), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.background(v.value0.background), PrestoDOM_Properties.hintColor(v.value0.hintColor), PrestoDOM_Properties.inputType(v.value0.inputType), PrestoDOM_Properties.visibility(v.value0.editTextVisibility), PrestoDOM_Properties.gravity(v.value0.gravity), PrestoDOM_Properties.textSize(v.value0.textSize), PrestoDOM_Properties.text(v.value0.text) ]), PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(v.value0.iconWidth), PrestoDOM_Properties.height(v.value0.iconHeight), PrestoDOM_Properties.visibility((function () {
              var $5 = v.value0.iconUrl === "";
              if ($5) {
                  return PrestoDOM_Types_DomAttributes.GONE.value;
              };
              return PrestoDOM_Types_DomAttributes.VISIBLE.value;
          })()), PrestoDOM_Properties.imageUrl(v.value0.iconUrl), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.PaddingLeft(11)) ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(v.value0.lineSeparatorHeight + 4 | 0)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.margin(v.value0.lineSeparatorMargin) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(v.value0.lineSeparatorHeight)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(v.value0.lineSeparatorHeight + 4 | 0)), PrestoDOM_Properties.background(v.value0.lineSeparatorColor), PrestoDOM_Properties.visibility(v.value0.tickVisibility) ])([  ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(v.value0.lineSeparatorHeight)), PrestoDOM_Properties.background(v.value0.lineSeparatorColor), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.MarginTop((function () {
              if (v.value0.tickVisibility instanceof PrestoDOM_Types_DomAttributes.VISIBLE) {
                  return 4;
              };
              return 0;
  ...
  exports["view"] = view;
})(PS["UI.Components.View.EditTextV2"] = PS["UI.Components.View.EditTextV2"] || {});
(function(exports) {
    "use strict";
  /* global Symbol */
...
(function(exports) {
  ...
  var view = function (push) {
      return function (v) {
          return PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(v.cardHeight), PrestoDOM_Properties.background(v.background), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Events.onClick(push)(Data_Function["const"](new UI_Components_Controller_PaymentOptions.ToggleOption(v.id))), PrestoDOM_Properties.visibility((function () {
              if (v.isFormVisible) {
                  return PrestoDOM_Types_DomAttributes.VISIBLE.value;
              };
              return PrestoDOM_Types_DomAttributes.GONE.value;
          })()) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.MarginLeft(16)) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(24)), PrestoDOM_Properties.cornerRadius(12.0), PrestoDOM_Properties.stroke("1,#8b8b8b"), PrestoDOM_Properties.background("#ffffff"), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(0, 0, 12, 0)), PrestoDOM_Properties.visibility(v.checkBoxVisibility) ])([ PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(14)), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(14)), PrestoDOM_Properties.cornerRadius(7.0), PrestoDOM_Properties.visibility(v.checkVisibility), PrestoDOM_Properties.background("#b93540"), PrestoDOM_Properties.stroke("1,#8b8b8b") ]) ]), PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(v.iconSize), PrestoDOM_Properties.height(v.iconSize), PrestoDOM_Properties.visibility((function () {
              var $4 = v.bankIconUrl === "";
              if ($4) {
                  return PrestoDOM_Types_DomAttributes.GONE.value;
              };
              return PrestoDOM_Types_DomAttributes.VISIBLE.value;
          })()), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.MarginRight(12)), PrestoDOM_Properties.imageUrl(v.bankIconUrl) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.weight(1.0) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.V.create((Data_String_CodePoints.length(v.text) * 11 | 0) + 18 | 0)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.text(v.text), PrestoDOM_Properties.color(v.textColor), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value), PrestoDOM_Properties.textSize(18), PrestoDOM_Properties.typeface(v.typeface), PrestoDOM_Properties.fontStyle(v.font) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.V.create((Data_String_CodePoints.length(v.paymentOptionOffer) * 10 | 0) + 16 | 0)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.visibility((function () {
              var $5 = v.paymentOptionOffer === "";
              if ($5) {
                  return PrestoDOM_Types_DomAttributes.GONE.value;
              };
              return PrestoDOM_Types_DomAttributes.VISIBLE.value;
          })()), PrestoDOM_Properties.text(v.paymentOptionOffer), PrestoDOM_Properties.background("#ca001a"), PrestoDOM_Properties.cornerRadius(9.0), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(8, 0, 8, 0)), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(8, 2, 0, 8)), PrestoDOM_Properties.color("#ffffff"), PrestoDOM_Properties.textSize(12), PrestoDOM_Properties.fontStyle(v.font) ]) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.visibility((function () {
              var $6 = v.offerText === "";
              if ($6) {
                  return PrestoDOM_Types_DomAttributes.GONE.value;
              };
              return PrestoDOM_Types_DomAttributes.VISIBLE.value;
          })()), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.TOP_VERTICAL.value), PrestoDOM_Properties.textSize(15), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(0, 0, 0, 0)), PrestoDOM_Properties.typeface(v.typeface), PrestoDOM_Properties.text(v.offerText), PrestoDOM_Properties.color(v.offerTextColor), PrestoDOM_Properties.fontStyle(v.font) ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(28)), PrestoDOM_Properties.visibility((function () {
              var $7 = v.rightArrowUrl === "";
              if ($7) {
                  return PrestoDOM_Types_DomAttributes.GONE.value;
              };
              return PrestoDOM_Types_DomAttributes.VISIBLE.value;
          })()), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.MarginRight(10)) ])([ PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(v.rightArrowWidth), PrestoDOM_Properties.height(v.rightArrowHeight), PrestoDOM_Properties.imageUrl(v.rightArrowUrl) ]) ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(1)), PrestoDOM_Properties.visibility((function () {
              var $8 = v.lineSeparaterColor === "";
              if ($8) {
                  return PrestoDOM_Types_DomAttributes.GONE.value;
              };
              return PrestoDOM_Types_DomAttributes.VISIBLE.value;
...
(function(exports) {
  ...
  var UI_Components_Controller_PrimaryButton = PS["UI.Components.Controller.PrimaryButton"];
  var UI_Components_Controller_ToolBar = PS["UI.Components.Controller.ToolBar"];                 
  var JioAction = (function () {
      function JioAction() {

      };
      JioAction.value = new JioAction();
      return JioAction;
  })();
  var ToolBarAction = (function () {
      function ToolBarAction(value0) {
  ...
  var EditTextV2Action = (function () {
      function EditTextV2Action(value0) {
          this.value0 = value0;
      };
      EditTextV2Action.create = function (value0) {
          return new EditTextV2Action(value0);
      };
      return EditTextV2Action;
  })();
  var CloseSheet = (function () {
      function CloseSheet() {

      };
      CloseSheet.value = new CloseSheet();
      return CloseSheet;
  })();
  var CloseWalletSheet = (function () {
      function CloseWalletSheet() {

      };
      CloseWalletSheet.value = new CloseWalletSheet();
      return CloseWalletSheet;
  })();
  var DismissAction = (function () {
      function DismissAction() {

      };
      DismissAction.value = new DismissAction();
      return DismissAction;
  })();
  var SubmitButtonAction = (function () {
      function SubmitButtonAction(value0) {
          this.value0 = value0;
      };
      SubmitButtonAction.create = function (value0) {
          return new SubmitButtonAction(value0);
      };
      return SubmitButtonAction;
  })();
  var initialState = function (input) {
      return {
          amountViewState: UI_Components_Controller_AmountView.initialState,
          walletIcon: "ic_paytm",
          sheetVisibility: false,
          walletSheetVisibility: false,
          popularBankState: UI_Components_Controller_BankListItem.initialState,
          bankListItemState: UI_Components_Controller_BankListItem.initialState
      };
  };
  var $$eval = function (v) {
      return function (state) {
          if (v instanceof JioAction) {
              return PrestoDOM_Utils["continue"](state);
          };
          if (v instanceof CloseSheet) {
              return PrestoDOM_Utils["continue"]((function () {
                  var $14 = {};
                  for (var $15 in state) {
                  ...
                  $14.sheetVisibility = !state.sheetVisibility;
                  return $14;
              })());
          };
          if (v instanceof CloseWalletSheet) {
              return PrestoDOM_Utils["continue"]((function () {
                  var $17 = {};
                  for (var $18 in state) {
                      if ({}.hasOwnProperty.call(state, $18)) {
                  ...
                  $17.walletSheetVisibility = !state.walletSheetVisibility;
                  return $17;
              })());
          };
          if (v instanceof DismissAction) {
              return PrestoDOM_Utils["continue"]((function () {
                  var $20 = {};
                  for (var $21 in state) {
                  ...
                  $20.sheetVisibility = false;
                  $20.walletSheetVisibility = false;
                  return $20;
              })());
          };
          if (v instanceof PaymentOptionsV2Action) {
              if (v.value0.value0 === 1) {
                  return PrestoDOM_Utils.exit(Types.JioUpi.value);
              };
              if (v.value0.value0 === 2) {
                  return PrestoDOM_Utils["continue"]((function () {
                      ...
                      $24.walletSheetVisibility = !state.walletSheetVisibility;
                      $24.walletIcon = "ic_jiomoney";
                      return $24;
                  })());
              };
              if (v.value0.value0 === 3) {
                  return PrestoDOM_Utils["continue"]((function () {
                      ...
                      $27.walletSheetVisibility = !state.walletSheetVisibility;
                      $27.walletIcon = "ic_paytm";
                      return $27;
                  })());
              };
              if (v.value0.value0 === 4) {
                  return PrestoDOM_Utils["continue"]((function () {
                      ...
                      $30.walletSheetVisibility = !state.walletSheetVisibility;
                      $30.walletIcon = "ic_phonepe";
                      return $30;
                  })());
              };
              return PrestoDOM_Utils["continue"](state);
          ...
          if (v instanceof PaymentOptionsAction) {
              if (v.value0.value0 === 1) {
                  return PrestoDOM_Utils.exit(Types.JioCreditCard.value);
              };
              if (v.value0.value0 === 2) {
                  return PrestoDOM_Utils.exit(Types.JioDebitCard.value);
              };
              if (v.value0.value0 === 3) {
                  return PrestoDOM_Utils["continue"]((function () {
                      var $36 = {};
                      ...
                      $36.sheetVisibility = !state.sheetVisibility;
                      return $36;
                  })());
              };
              return PrestoDOM_Utils.exit(Types.JioDebitCard.value);
  ...
  exports["EditTextV2Action"] = EditTextV2Action;
  exports["CloseSheet"] = CloseSheet;
  exports["CloseWalletSheet"] = CloseWalletSheet;
  exports["DismissAction"] = DismissAction;
  exports["SubmitButtonAction"] = SubmitButtonAction;
  exports["initialState"] = initialState;
  exports["eval"] = $$eval;
})(PS["UI.Merchants.Jio.Controller.JioScreen"] = PS["UI.Merchants.Jio.Controller.JioScreen"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  ...
  var UI_Components_View_EditTextV2 = PS["UI.Components.View.EditTextV2"];
  var UI_Components_View_PaymentOptions = PS["UI.Components.View.PaymentOptions"];
  var UI_Components_View_PaymentOptionsV2 = PS["UI.Components.View.PaymentOptionsV2"];
  var UI_Components_View_PrimaryButton = PS["UI.Components.View.PrimaryButton"];
  var UI_Components_View_ToolBar = PS["UI.Components.View.ToolBar"];
  var UI_Merchants_Jio_Config = PS["UI.Merchants.Jio.Config"];
  var UI_Merchants_Jio_Controller_JioScreen = PS["UI.Merchants.Jio.Controller.JioScreen"];                 
  var view = function (push) {
      return function (state) {
          return PrestoDOM_Elements_Elements.relativeLayout_("JioScreen")([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.background("#ffffff"), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value) ])([ UI_Components_View_ToolBar.view(function ($13) {
              return push(UI_Merchants_Jio_Controller_JioScreen.ToolBarAction.create($13));
          })(UI_Merchants_Jio_Config.toolBarConfigJio), PrestoDOM_Elements_Elements.scrollView([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value) ])([ UI_Components_View_AmountView.view(function ($14) {
              return push(UI_Merchants_Jio_Controller_JioScreen.AmountViewAction.create($14));
          })(UI_Merchants_Jio_Config.amountConfigJio)(state.amountViewState), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(20, 20, 20, 0)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.stroke("1,#e1e1e1"), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(0, 4, 0, 4)), PrestoDOM_Properties.cornerRadius(4.0) ])([ UI_Components_View_PaymentOptionsV2.view(function ($15) {
              return push(UI_Merchants_Jio_Controller_JioScreen.PaymentOptionsV2Action.create($15));
          })(UI_Merchants_Jio_Config.jioUpiConfig) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.text("Wallets"), PrestoDOM_Properties.color("#a1a1a1"), PrestoDOM_Properties.textSize(18), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.MarginVertical(20, 10)) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.stroke("1,#e1e1e1"), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(0, 4, 0, 4)), PrestoDOM_Properties.cornerRadius(4.0) ])([ UI_Components_View_PaymentOptionsV2.view(function ($16) {
              return push(UI_Merchants_Jio_Controller_JioScreen.PaymentOptionsV2Action.create($16));
          })(UI_Merchants_Jio_Config.jioMoneyConfig), UI_Components_View_PaymentOptionsV2.view(function ($17) {
              return push(UI_Merchants_Jio_Controller_JioScreen.PaymentOptionsV2Action.create($17));
          })(UI_Merchants_Jio_Config.jioPaytmConfig), UI_Components_View_PaymentOptionsV2.view(function ($18) {
              return push(UI_Merchants_Jio_Controller_JioScreen.PaymentOptionsV2Action.create($18));
          })(UI_Merchants_Jio_Config.jioPhonepeConfig) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.text("Other Payment options"), PrestoDOM_Properties.color("#a1a1a1"), PrestoDOM_Properties.textSize(18), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.MarginVertical(20, 10)) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.stroke("1,#e1e1e1"), PrestoDOM_Properties.cornerRadius(4.0), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(0, 4, 0, 4)) ])([ UI_Components_View_PaymentOptions.view(function ($19) {
              return push(UI_Merchants_Jio_Controller_JioScreen.PaymentOptionsAction.create($19));
          })(UI_Merchants_Jio_Config.jioCredit), UI_Components_View_PaymentOptions.view(function ($20) {
              return push(UI_Merchants_Jio_Controller_JioScreen.PaymentOptionsAction.create($20));
          })(UI_Merchants_Jio_Config.jioDebit), UI_Components_View_PaymentOptions.view(function ($21) {
              return push(UI_Merchants_Jio_Controller_JioScreen.PaymentOptionsAction.create($21));
          })(UI_Merchants_Jio_Config.jioNet) ]) ]) ]) ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.background("#616161"), PrestoDOM_Properties.alpha(0.8), PrestoDOM_Properties.visibility((function () {
              var $10 = state.sheetVisibility || state.walletSheetVisibility;
              if ($10) {
                  return PrestoDOM_Types_DomAttributes.VISIBLE.value;
              };
              return PrestoDOM_Types_DomAttributes.GONE.value;
          })()), PrestoDOM_Properties.clickable(state.sheetVisibility || state.walletSheetVisibility), PrestoDOM_Properties.focusable(state.sheetVisibility || state.walletSheetVisibility), PrestoDOM_Events.onClick(push)(Data_Function["const"](UI_Merchants_Jio_Controller_JioScreen.DismissAction.value)) ])([  ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.visibility((function () {
              if (state.sheetVisibility) {
                  return PrestoDOM_Types_DomAttributes.VISIBLE.value;
              };
              return PrestoDOM_Types_DomAttributes.GONE.value;
          })()), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(8, 80, 8, 0)), PrestoDOM_Properties.background("#ffffff"), PrestoDOM_Properties.cornerRadius(5.0) ])([ PrestoDOM_Elements_Elements.scrollView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(60)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.text("Choose a Bank"), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.PaddingLeft(32)), PrestoDOM_Properties.textSize(20) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(32)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Events.onClick(push)(Data_Function["const"](UI_Merchants_Jio_Controller_JioScreen.CloseSheet.value)), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value) ])([ PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(14)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(14)), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.MarginRight(8)), PrestoDOM_Properties.imageUrl("ic_close_gray") ]) ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(1)), PrestoDOM_Properties.background("#E0E0E0"), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(32, 0, 32, 0)) ])([  ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(16, 8, 16, 8)) ])([ UI_Components_View_BankListItem.view(function ($22) {
              return push(UI_Merchants_Jio_Controller_JioScreen.PopularBanksAction.create($22));
          })(UI_Merchants_Jio_Config.jioBankListItem)({
              active: state.bankListItemState.active,
              name: "AXIS Bank (Retail)",
              logo: state.bankListItemState.logo,
              index: 1
          }), UI_Components_View_BankListItem.view(function ($23) {
              return push(UI_Merchants_Jio_Controller_JioScreen.PopularBanksAction.create($23));
          })(UI_Merchants_Jio_Config.jioBankListItem)({
              active: state.bankListItemState.active,
              name: "HDFC Bank (Retail)",
              logo: state.bankListItemState.logo,
              index: 2
          }), UI_Components_View_BankListItem.view(function ($24) {
              return push(UI_Merchants_Jio_Controller_JioScreen.PopularBanksAction.create($24));
          })(UI_Merchants_Jio_Config.jioBankListItem)({
              active: state.bankListItemState.active,
              name: "ICICI Bank (Retail)",
              logo: state.bankListItemState.logo,
              index: 3
          }), UI_Components_View_BankListItem.view(function ($25) {
              return push(UI_Merchants_Jio_Controller_JioScreen.PopularBanksAction.create($25));
          })(UI_Merchants_Jio_Config.jioBankListItem)({
              active: state.bankListItemState.active,
              name: "Kotak Bank",
              logo: state.bankListItemState.logo,
              index: 4
          }), UI_Components_View_BankListItem.view(function ($26) {
              return push(UI_Merchants_Jio_Controller_JioScreen.PopularBanksAction.create($26));
          })(UI_Merchants_Jio_Config.jioBankListItem)({
              active: state.bankListItemState.active,
              name: "State Bank of India",
              logo: state.bankListItemState.logo,
              index: 5
          }) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(1)), PrestoDOM_Properties.background("#E0E0E0"), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(32, 0, 32, 0)) ])([  ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(16, 8, 16, 8)) ])([ UI_Components_View_BankListItem.view(function ($27) {
              return push(UI_Merchants_Jio_Controller_JioScreen.BankListItemAction.create($27));
          })(UI_Merchants_Jio_Config.jioBankListItem)({
              active: state.bankListItemState.active,
              name: "Allahabad Bank(Retail)",
              logo: state.bankListItemState.logo,
              index: 1
          }), UI_Components_View_BankListItem.view(function ($28) {
              return push(UI_Merchants_Jio_Controller_JioScreen.BankListItemAction.create($28));
          })(UI_Merchants_Jio_Config.jioBankListItem)({
              active: state.bankListItemState.active,
              name: "Andhra Bank (Retail)",
              logo: state.bankListItemState.logo,
              index: 2
          }), UI_Components_View_BankListItem.view(function ($29) {
              return push(UI_Merchants_Jio_Controller_JioScreen.BankListItemAction.create($29));
          })(UI_Merchants_Jio_Config.jioBankListItem)({
              active: state.bankListItemState.active,
              name: "ICICI Bank (Retail)",
              logo: state.bankListItemState.logo,
              index: 3
          }), UI_Components_View_BankListItem.view(function ($30) {
              return push(UI_Merchants_Jio_Controller_JioScreen.BankListItemAction.create($30));
          })(UI_Merchants_Jio_Config.jioBankListItem)({
              active: state.bankListItemState.active,
              name: "Kotak Bank",
              logo: state.bankListItemState.logo,
              index: 4
          }), UI_Components_View_BankListItem.view(function ($31) {
              return push(UI_Merchants_Jio_Controller_JioScreen.BankListItemAction.create($31));
          })(UI_Merchants_Jio_Config.jioBankListItem)({
              active: state.bankListItemState.active,
              name: "State Bank of India",
              logo: state.bankListItemState.logo,
              index: 5
          }) ]) ]) ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.visibility((function () {
              if (state.walletSheetVisibility) {
                  return PrestoDOM_Types_DomAttributes.VISIBLE.value;
              };
              return PrestoDOM_Types_DomAttributes.GONE.value;
          })()) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(290)), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.Margin(12, 0, 12, 0)), PrestoDOM_Properties.background("#ffffff"), PrestoDOM_Properties.cornerRadius(8.0), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.PaddingLeft(28)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_HORIZONTAL.value) ])([ PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(60)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(60)), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.MarginTop(8)), PrestoDOM_Properties.imageUrl(state.walletIcon) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(80)), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value), PrestoDOM_Properties.text("Please provide your registered mobile number to send you an OTP"), PrestoDOM_Properties.textSize(20) ]), UI_Components_View_EditTextV2.view(function ($32) {
              return push(UI_Merchants_Jio_Controller_JioScreen.EditTextV2Action.create($32));
          })(UI_Merchants_Jio_Config.jioWalletEditText), UI_Components_View_PrimaryButton.view(function ($33) {
              return push(UI_Merchants_Jio_Controller_JioScreen.SubmitButtonAction.create($33));
          })(UI_Merchants_Jio_Config.jioSubmitButton) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Events.onClick(push)(Data_Function["const"](UI_Merchants_Jio_Controller_JioScreen.CloseWalletSheet.value)), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(0, 8, 8, 0)) ])([ PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(14)), PrestoDOM_Properties.imageUrl("ic_close_gray") ]) ]) ]) ]) ]);
      };
  };
  var screen = function (input) {
      return {
          initialState: UI_Merchants_Jio_Controller_JioScreen.initialState(input),
          view: view,
          "eval": UI_Merchants_Jio_Controller_JioScreen["eval"]
      };
  };
  exports["screen"] = screen;
  exports["view"] = view;
})(PS["UI.Merchants.Jio.View.JioScreen"] = PS["UI.Merchants.Jio.View.JioScreen"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Data_Function = PS["Data.Function"];
  ...
  var Types = PS["Types"];
  var UI_Components_Config_EditText = PS["UI.Components.Config.EditText"];
  var UI_Components_Controller_EditText = PS["UI.Components.Controller.EditText"];                 
  var view = function (push) {
      return function (v) {
          return PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(v.value0.parentHeight), PrestoDOM_Properties.width(v.value0.parentWidth), PrestoDOM_Properties.margin(v.value0.parentMargin), PrestoDOM_Properties.padding(v.value0.parentPadding), PrestoDOM_Properties.background(v.value0.parentBackground), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.visibility((function () {
              if (v.value0.isFormVisible) {
                  return PrestoDOM_Types_DomAttributes.VISIBLE.value;
              };
              return PrestoDOM_Types_DomAttributes.GONE.value;
          })()) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.height(v.value0.textHeight), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.text(v.value0.text), PrestoDOM_Properties.textSize(v.value0.textSize), PrestoDOM_Properties.color(v.value0.textColor), PrestoDOM_Properties.typeface(v.value0.typeface), PrestoDOM_Properties.margin(v.value0.textMargin), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value), PrestoDOM_Properties.visibility(v.value0.visibility), PrestoDOM_Properties.fontStyle(v.value0.font) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(v.value0.rowHeight), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.background("#f5f5f5"), PrestoDOM_Properties.stroke(v.value0.rowStroke), PrestoDOM_Properties.cornerRadius(v.value0.rowCornerRadius), PrestoDOM_Properties.padding(v.value0.rowPadding) ])([ PrestoDOM_Elements_Elements.editText([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(10, 0, 0, 0)), PrestoDOM_Properties.inputType(v.value0.inputType), PrestoDOM_Properties.background(v.value0.editTextBackground), PrestoDOM_Properties.hint(v.value0.hint), PrestoDOM_Properties.textSize(v.value0.editTextSize) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(1)), PrestoDOM_Properties.background("#bdbdbd"), PrestoDOM_Properties.visibility(v.value0.pipeVisibility) ])([  ]), PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(v.value0.imageWidth), PrestoDOM_Properties.visibility(v.value0.imageVisibility), PrestoDOM_Properties.imageUrl(v.value0.imageUrl), PrestoDOM_Properties.background(v.value0.imageBackground), PrestoDOM_Properties.padding(v.value0.imagePadding) ]) ]) ]);
      };
  };
  exports["view"] = view;
})(PS["UI.Components.View.EditText"] = PS["UI.Components.View.EditText"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Effect = PS["Effect"];
  ...
  var UI_Components_Controller_PrimaryButton = PS["UI.Components.Controller.PrimaryButton"];
  var UI_Components_Controller_ToolBar = PS["UI.Components.Controller.ToolBar"];                 
  var UpiAction = (function () {
      function UpiAction() {

      };
      UpiAction.value = new UpiAction();
      return UpiAction;
  })();
  var ToolBarAction = (function () {
      function ToolBarAction(value0) {
  ...
  var EditTextAction = (function () {
      function EditTextAction(value0) {
          this.value0 = value0;
      };
      EditTextAction.create = function (value0) {
          return new EditTextAction(value0);
      };
  ...
  var $$eval = function (v) {
      return function (state) {
          if (v instanceof UpiAction) {
              return PrestoDOM_Utils["continue"](state);
          };
          return PrestoDOM_Utils["continue"](state);
      };
  };
  exports["UpiAction"] = UpiAction;
  exports["ToolBarAction"] = ToolBarAction;
  exports["PayButtonAction"] = PayButtonAction;
  exports["EditTextAction"] = EditTextAction;
  exports["initialState"] = initialState;
  exports["eval"] = $$eval;
})(PS["UI.Merchants.Jio.Controller.UpiScreen"] = PS["UI.Merchants.Jio.Controller.UpiScreen"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  ...
  var PrestoDOM_Properties = PS["PrestoDOM.Properties"];
  var PrestoDOM_Types_DomAttributes = PS["PrestoDOM.Types.DomAttributes"];
  var UI_Components_View_EditText = PS["UI.Components.View.EditText"];
  var UI_Components_View_PrimaryButton = PS["UI.Components.View.PrimaryButton"];
  var UI_Components_View_ToolBar = PS["UI.Components.View.ToolBar"];
  var UI_Merchants_Jio_Config = PS["UI.Merchants.Jio.Config"];
  var UI_Merchants_Jio_Controller_UpiScreen = PS["UI.Merchants.Jio.Controller.UpiScreen"];                 
  var view = function (push) {
      return function (state) {
          return PrestoDOM_Elements_Elements.linearLayout_("UpiScreen")([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.background("#ffffff"), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value) ])([ UI_Components_View_ToolBar.view(function ($0) {
              return push(UI_Merchants_Jio_Controller_UpiScreen.ToolBarAction.create($0));
          })(UI_Merchants_Jio_Config.toolBarConfigJio), PrestoDOM_Elements_Elements.scrollView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(500)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.stroke("1,#aaaaaa"), PrestoDOM_Properties.cornerRadius(3.0) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(100)), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(16, 16, 16, 16)) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0) ])([ PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(150)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(80)), PrestoDOM_Properties.imageUrl("upi_logo") ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(100)) ])([ PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(80)), PrestoDOM_Properties.imageUrl("jio_billdesk") ]) ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(1)), PrestoDOM_Properties.background("#aaaaaa") ])([  ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(150)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(16, 16, 16, 16)) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.text("Merchant Name"), PrestoDOM_Properties.color("#000000") ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.text("RELIANCEJIO"), PrestoDOM_Properties.color("#000000") ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.text("Payment Amount"), PrestoDOM_Properties.color("#000000") ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.text("\u20b9 19.00"), PrestoDOM_Properties.color("#000000") ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.text("Transaction Refrence No"), PrestoDOM_Properties.color("#000000") ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.text("PIC4681434682374"), PrestoDOM_Properties.color("#000000") ]) ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(1)), PrestoDOM_Properties.background("#aaaaaa") ])([  ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.Padding(16, 16, 16, 16)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(40)), PrestoDOM_Properties.text("Enter your VPA"), PrestoDOM_Properties.color("#000000"), PrestoDOM_Properties.textSize(18) ]), UI_Components_View_EditText.view(function ($1) {
              return push(UI_Merchants_Jio_Controller_UpiScreen.EditTextAction.create($1));
          })(UI_Merchants_Jio_Config.jioVpaEditText), UI_Components_View_PrimaryButton.view(function ($2) {
              return push(UI_Merchants_Jio_Controller_UpiScreen.PayButtonAction.create($2));
          })(UI_Merchants_Jio_Config.jioPayButton), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.MarginTop(24)) ])([ PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(125)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.VERTICAL.value) ])([ PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.color("#000000"), PrestoDOM_Properties.text("Cancel and Go back") ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(1)), PrestoDOM_Properties.background("#000000") ]) ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(0)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.weight(1.0), PrestoDOM_Properties.text("to merchant"), PrestoDOM_Properties.color("#000000"), PrestoDOM_Properties.padding(new PrestoDOM_Types_DomAttributes.PaddingLeft(4)) ]) ]) ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(40)), PrestoDOM_Properties.orientation(PrestoDOM_Types_DomAttributes.HORIZONTAL.value), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER.value) ])([ PrestoDOM_Elements_Elements.imageView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(20)), PrestoDOM_Properties.imageUrl("jio_lock_black") ]), PrestoDOM_Elements_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(120)), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.text("PCI SDD Certified"), PrestoDOM_Properties.color("#000000"), PrestoDOM_Properties.gravity(PrestoDOM_Types_DomAttributes.CENTER_VERTICAL.value), PrestoDOM_Properties.margin(new PrestoDOM_Types_DomAttributes.MarginLeft(5)) ]) ]), PrestoDOM_Elements_Elements.linearLayout([ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.MATCH_PARENT.value), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(1)), PrestoDOM_Properties.background("#aaaaaa") ])([  ]) ]) ]) ]);
      };
  };
  var screen = function (input) {
      return {
          initialState: UI_Merchants_Jio_Controller_UpiScreen.initialState(input),
          view: view,
          "eval": UI_Merchants_Jio_Controller_UpiScreen["eval"]
      };
  };
  exports["screen"] = screen;
  exports["view"] = view;
})(PS["UI.Merchants.Jio.View.UpiScreen"] = PS["UI.Merchants.Jio.View.UpiScreen"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var $foreign = PS["Core"];
...
>>>>>>> f4e4ce180f74ab5dae0089b2c6df04cae766c93e
  ...
  var UI_Merchants_Dream11_View_WalletsScreen = PS["UI.Merchants.Dream11.View.WalletsScreen"];
<<<<<<< HEAD
  var UI_Merchants_Goibibo_View_CreditCardScreen = PS["UI.Merchants.Goibibo.View.CreditCardScreen"];
  var UI_Merchants_Goibibo_View_DebitCardScreen = PS["UI.Merchants.Goibibo.View.DebitCardScreen"];
  var UI_Merchants_Goibibo_View_GoibiboScreen = PS["UI.Merchants.Goibibo.View.GoibiboScreen"];
  var UI_Merchants_Goibibo_View_NetBankingScreen = PS["UI.Merchants.Goibibo.View.NetBankingScreen"];
  var UI_Merchants_Goibibo_View_UpiScreen = PS["UI.Merchants.Goibibo.View.UpiScreen"];
  var UI_Merchants_Grofers_View_GrofersScreen = PS["UI.Merchants.Grofers.View.GrofersScreen"];
  var UI_Merchants_Grofers_View_NewCardScreen = PS["UI.Merchants.Grofers.View.NewCardScreen"];
  var UI_Merchants_Grofers_View_SelectBankScreen = PS["UI.Merchants.Grofers.View.SelectBankScreen"];
  var UI_Merchants_Grofers_View_SelectUPIScreen = PS["UI.Merchants.Grofers.View.SelectUPIScreen"];
  var UI_Merchants_Jio_View_CreditCardScreen = PS["UI.Merchants.Jio.View.CreditCardScreen"];
  var UI_Merchants_Jio_View_DebitCardScreen = PS["UI.Merchants.Jio.View.DebitCardScreen"];
  var UI_Merchants_Jio_View_JioScreen = PS["UI.Merchants.Jio.View.JioScreen"];
  var UI_Merchants_Jio_View_UpiScreen = PS["UI.Merchants.Jio.View.UpiScreen"];
  var UI_Merchants_Ola_View_OlaScreen = PS["UI.Merchants.Ola.View.OlaScreen"];
  var UI_Merchants_RedBus_View_NetBankingScreen = PS["UI.Merchants.RedBus.View.NetBankingScreen"];
  var UI_Merchants_RedBus_View_RedBusScreen = PS["UI.Merchants.RedBus.View.RedBusScreen"];
  var UI_Merchants_SpiceJet_View_SpiceJetScreen = PS["UI.Merchants.SpiceJet.View.SpiceJetScreen"];
  var UI_Merchants_Vodafone_View_AddCardScreen = PS["UI.Merchants.Vodafone.View.AddCardScreen"];
  var UI_Merchants_Vodafone_View_SelectBankScreen = PS["UI.Merchants.Vodafone.View.SelectBankScreen"];
=======
  var UI_Merchants_Goibibo_View_GoibiboScreen = PS["UI.Merchants.Goibibo.View.GoibiboScreen"];
  var UI_Merchants_Grofers_View_GrofersScreen = PS["UI.Merchants.Grofers.View.GrofersScreen"];
  var UI_Merchants_Jio_View_JioScreen = PS["UI.Merchants.Jio.View.JioScreen"];
...
>>>>>>> f4e4ce180f74ab5dae0089b2c6df04cae766c93e
  ...
  var UI_View_Screens_TestingScreen = PS["UI.View.Screens.TestingScreen"];
<<<<<<< HEAD
  var jioApp = Control_Bind.bind(Control_Monad_Free.freeBind)(Presto_Core_Types_Language_Flow.runScreen(UI_Merchants_Jio_View_JioScreen.screen(Data_Unit.unit)))(function (v) {
      return Control_Bind.bind(Control_Monad_Free.freeBind)((function () {
          if (v instanceof Types.JioCreditCard) {
              return Presto_Core_Types_Language_Flow.runScreen(UI_Merchants_Jio_View_CreditCardScreen.screen(Data_Unit.unit));
          };
          if (v instanceof Types.JioDebitCard) {
              return Presto_Core_Types_Language_Flow.runScreen(UI_Merchants_Jio_View_DebitCardScreen.screen(Data_Unit.unit));
          };
          if (v instanceof Types.JioUpi) {
              return Presto_Core_Types_Language_Flow.runScreen(UI_Merchants_Jio_View_UpiScreen.screen(Data_Unit.unit));
          };
          return Presto_Core_Types_Language_Flow.runScreen(UI_Merchants_Jio_View_CreditCardScreen.screen(Data_Unit.unit));
=======
  var bigBasketPaymentSuccessful = Control_Bind.bind(Control_Monad_Free.freeBind)(Debug_Trace.spy(Debug_Trace.warn())("ASDF")(Presto_Core_Types_Language_Flow.runScreen(UI_Merchants_BigBasket_View_PaymentSuccessful.screen({
...
<<<<<<< HEAD
  var appFlow = function (recreated) {
      return Control_Bind.bind(Control_Monad_Free.freeBind)(Control_Apply.applySecond(Control_Monad_Free.freeApply)(Presto_Core_Types_Language_Flow.initUI)(jioApp))(function (v) {
=======
  var bigBasketApp = Control_Bind.bind(Control_Monad_Free.freeBind)(Presto_Core_Types_Language_Flow.runScreen(UI_Merchants_BigBasket_View_BigBasketScreen.screen({
      amount: "1300.0",
      preferredOptions: [  ],
