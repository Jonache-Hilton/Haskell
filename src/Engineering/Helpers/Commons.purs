...
liftRunScreen :: forall a s o. (o -> FailBack o) -> (Screen a s o) -> FlowBT PaymentPageError o
liftRunScreen f a = BackT <<< ExceptT $ Right <$> (oneOf [ f <$> showScreen a, onBackPress ])
...
userInteraction :: forall i. String -> Prop i
